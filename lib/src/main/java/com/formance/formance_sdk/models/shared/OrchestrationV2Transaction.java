...
public class OrchestrationV2Transaction {
    ...
    public OrchestrationV2Transaction withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public OrchestrationV2Transaction(@JsonProperty("id") Long id, @JsonProperty("metadata") java.util.Map<String, String> metadata, @JsonProperty("postings") V2Posting[] postings, @JsonProperty("timestamp") OffsetDateTime timestamp) {
        this.id = id;
        this.metadata = metadata;
        this.postings = postings;
        this.timestamp = timestamp;
