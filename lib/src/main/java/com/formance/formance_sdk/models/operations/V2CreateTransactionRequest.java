...
public class V2CreateTransactionRequest {
    ...
    public V2CreateTransactionRequest(@JsonProperty("V2PostTransaction") com.formance.formance_sdk.models.shared.V2PostTransaction v2PostTransaction, @JsonProperty("ledger") String ledger) {
        this.v2PostTransaction = v2PostTransaction;
        this.ledger = ledger;
  }
}
