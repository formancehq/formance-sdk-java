...
public class V2Workflow {
    ...
    public V2Workflow(@JsonProperty("config") V2WorkflowConfig config, @JsonProperty("createdAt") OffsetDateTime createdAt, @JsonProperty("id") String id, @JsonProperty("updatedAt") OffsetDateTime updatedAt) {
        this.config = config;
        this.createdAt = createdAt;
        this.id = id;
        this.updatedAt = updatedAt;
