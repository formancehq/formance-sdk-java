...
public class PoolsCursorCursor {
    ...
    public PoolsCursorCursor withData(Pool[] data) {
        this.data = data;
        return this;
    }
    ...
    public PoolsCursorCursor(@JsonProperty("data") Pool[] data, @JsonProperty("hasMore") Boolean hasMore, @JsonProperty("pageSize") Long pageSize) {
        this.data = data;
        this.hasMore = hasMore;
        this.pageSize = pageSize;
  }
