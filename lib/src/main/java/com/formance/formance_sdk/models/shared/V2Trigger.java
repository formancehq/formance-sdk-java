...
public class V2Trigger {
    ...
    public V2Trigger(@JsonProperty("createdAt") OffsetDateTime createdAt, @JsonProperty("event") String event, @JsonProperty("id") String id, @JsonProperty("workflowID") String workflowID) {
        this.createdAt = createdAt;
        this.event = event;
        this.id = id;
        this.workflowID = workflowID;
