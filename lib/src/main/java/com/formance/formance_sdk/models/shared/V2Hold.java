...
public class V2Hold {
    ...
    public V2Hold withDestination(java.lang.Object destination) {
    ...
    public V2Hold(@JsonProperty("description") String description, @JsonProperty("id") String id, @JsonProperty("metadata") java.util.Map<String, String> metadata, @JsonProperty("walletID") String walletID) {
        this.description = description;
        this.id = id;
        this.metadata = metadata;
        this.walletID = walletID;
