...
public class OrchestrationTransaction {
    ...
    public OrchestrationTransaction(@JsonProperty("id") Long id, @JsonProperty("metadata") java.util.Map<String, String> metadata, @JsonProperty("postings") Posting[] postings, @JsonProperty("reverted") Boolean reverted, @JsonProperty("timestamp") OffsetDateTime timestamp) {
        this.id = id;
        this.metadata = metadata;
        this.postings = postings;
        this.reverted = reverted;
