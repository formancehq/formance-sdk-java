...
public class TransferInitiationPayments {
    ...
    public TransferInitiationPayments(@JsonProperty("createdAt") OffsetDateTime createdAt, @JsonProperty("error") String error, @JsonProperty("paymentID") String paymentID, @JsonProperty("status") TransferInitiationStatus status) {
        this.createdAt = createdAt;
        this.error = error;
        this.paymentID = paymentID;
        this.status = status;
