...
public class PoliciesCursorResponseCursor {
    ...
    public PoliciesCursorResponseCursor withData(Policy[] data) {
        this.data = data;
        return this;
    }
    ...
    public PoliciesCursorResponseCursor(@JsonProperty("data") Policy[] data, @JsonProperty("hasMore") Boolean hasMore, @JsonProperty("pageSize") Long pageSize) {
        this.data = data;
        this.hasMore = hasMore;
        this.pageSize = pageSize;
  }
