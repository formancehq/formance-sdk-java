...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetConnectorTaskRequest req = new GetConnectorTaskRequest(Connector.MONEYCORP, "string");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            InstallConnectorRequest req = new InstallConnectorRequest("string", Connector.DUMMY_PAY);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReadConnectorConfigRequest req = new ReadConnectorConfigRequest(Connector.MONEYCORP);            
