...
public class GetManyConfigs200ResponseCursorAllOf {
  ...
  private List<ConfigActivated> data = new ArrayList<>();

  public GetManyConfigs200ResponseCursorAllOf() {
  }

  public GetManyConfigs200ResponseCursorAllOf data(List<ConfigActivated> data) {
    
    this.data = data;
    return this;
  }

  public GetManyConfigs200ResponseCursorAllOf addDataItem(ConfigActivated dataItem) {
  ...
  **/
  ...
  public List<ConfigActivated> getData() {
    return data;
  }


  public void setData(List<ConfigActivated> data) {
    this.data = data;
  }
