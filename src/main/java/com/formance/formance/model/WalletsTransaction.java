...
import com.formance.formance.model.WalletsPosting;
...
public class WalletsTransaction {
  ...
  private List<WalletsPosting> postings = new ArrayList<>();
  ...
  **/
  ...
  public WalletsTransaction postings(List<WalletsPosting> postings) {
    
    this.postings = postings;
    return this;
  }

  public WalletsTransaction addPostingsItem(WalletsPosting postingsItem) {
  ...
  **/
  ...
  public List<WalletsPosting> getPostings() {
    return postings;
  }


  public void setPostings(List<WalletsPosting> postings) {
    this.postings = postings;
  }
