...
public class Attempt {
  ...
  private ConfigActivated config;
  ...
  **/
  ...
  public Attempt config(ConfigActivated config) {
  ...
  **/
  ...
  public ConfigActivated getConfig() {
    return config;
  }


  public void setConfig(ConfigActivated config) {
    this.config = config;
  }
