...
public interface TransactionsApi {
   ...
   * 
   * @param ledger Name of the ledger. (required)
   * @param postTransaction The request body must contain one of the following objects:   - &#x60;postings&#x60;: suitable for simple transactions   - &#x60;script&#x60;: enabling more complex transactions with Numscript  (required)
