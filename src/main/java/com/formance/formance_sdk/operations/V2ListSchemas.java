...
public class V2ListSchemas {
    
    /**
     * V2_LIST_SCHEMAS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_SCHEMAS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ListSchemasRequest, V2ListSchemasResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ListSchemasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListSchemasRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListSchemasRequest request) {
        ...
        @Override
        public V2ListSchemasResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ListSchemasResponse.Builder resBuilder =
            ...
            V2ListSchemasResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2SchemasCursorResponse(Utils.unmarshal(response, new TypeReference<V2SchemasCursorResponse>() {}));
                } else {
