...
public class V3DeletePaymentServiceUser {
    
    /**
     * V3_DELETE_PAYMENT_SERVICE_USER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_DELETE_PAYMENT_SERVICE_USER_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_DELETE_PAYMENT_SERVICE_USER_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3DeletePaymentServiceUserRequest, V3DeletePaymentServiceUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3DeletePaymentServiceUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DeletePaymentServiceUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DeletePaymentServiceUserRequest request) {
        ...
        @Override
        public V3DeletePaymentServiceUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DeletePaymentServiceUserResponse.Builder resBuilder =
            ...
            V3DeletePaymentServiceUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PaymentServiceUserDeleteResponse(Utils.unmarshal(response, new TypeReference<V3PaymentServiceUserDeleteResponse>() {}));
                } else {
