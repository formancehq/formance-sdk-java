...
public class V2GetInstanceHistory {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetInstanceHistoryRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetInstanceHistoryRequest request) throws Exception {
        ...
        @Override
        public V2GetInstanceHistoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2GetWorkflowInstanceHistoryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2GetWorkflowInstanceHistoryResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
