...
import com.formance.formance_sdk.models.orchestration.V2GetWorkflowInstanceHistoryResponse;
...
public class V2GetInstanceHistory {
    
    /**
     * V2_GET_INSTANCE_HISTORY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_INSTANCE_HISTORY_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_GET_INSTANCE_HISTORY_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V2GetInstanceHistoryRequest, V2GetInstanceHistoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2GetInstanceHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2GetInstanceHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetInstanceHistoryRequest request) {
        ...
        @Override
        public V2GetInstanceHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetInstanceHistoryResponse.Builder resBuilder =
            ...
            V2GetInstanceHistoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2GetWorkflowInstanceHistoryResponse(Utils.unmarshal(response, new TypeReference<V2GetWorkflowInstanceHistoryResponse>() {}));
                } else {
