...
public class GetDeliveries {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeliveriesRequest, GetDeliveriesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeliveriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeliveriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeliveriesRequest request) {
        ...
        @Override
        public GetDeliveriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeliveriesResponse.Builder resBuilder =
            ...
            GetDeliveriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeliveriesResponse(Utils.unmarshal(response, new TypeReference<DeliveriesResponse>() {}));
                } else {
