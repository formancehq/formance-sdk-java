...
public class V2ListTriggers {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2ListTriggersRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListTriggersRequest request) throws Exception {
        ...
        @Override
        public V2ListTriggersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2ListTriggersResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2ListTriggersResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
