...
public class GetPoolBalancesLatest {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetPoolBalancesLatestRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPoolBalancesLatestRequest request) throws Exception {
        ...
        @Override
        public GetPoolBalancesLatestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PoolBalancesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPoolBalancesResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
