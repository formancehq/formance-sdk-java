...
import com.formance.formance_sdk.models.payments.PoolBalancesLatestResponse;
...
public class GetPoolBalancesLatest {
    
    /**
     * GET_POOL_BALANCES_LATEST_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_POOL_BALANCES_LATEST_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_POOL_BALANCES_LATEST_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPoolBalancesLatestRequest, GetPoolBalancesLatestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPoolBalancesLatestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPoolBalancesLatestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPoolBalancesLatestRequest request) {
        ...
        @Override
        public GetPoolBalancesLatestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPoolBalancesLatestResponse.Builder resBuilder =
            ...
            GetPoolBalancesLatestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPoolBalancesLatestResponse(Utils.unmarshal(response, new TypeReference<PoolBalancesLatestResponse>() {}));
                } else {
