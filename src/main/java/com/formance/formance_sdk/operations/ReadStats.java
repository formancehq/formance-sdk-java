...
import com.formance.formance_sdk.models.ledger.StatsResponse;
...
public class ReadStats {
    ...
    /**
     * READ_STATS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] READ_STATS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ReadStatsRequest, ReadStatsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReadStatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReadStatsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadStatsRequest request) {
        ...
        @Override
        public ReadStatsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReadStatsResponse.Builder resBuilder =
                    ReadStatsResponse
                            .builder()
            ...
            ReadStatsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStatsResponse(Utils.unmarshal(response, new TypeReference<StatsResponse>() {}));
                } else {
