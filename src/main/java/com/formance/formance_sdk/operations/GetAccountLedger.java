...
import com.formance.formance_sdk.models.ledger.AccountResponse;
...
public class GetAccountLedger {
    ...
    /**
     * GET_ACCOUNT_LEDGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_ACCOUNT_LEDGER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountLedgerRequest, GetAccountLedgerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAccountLedgerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountLedgerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountLedgerRequest request) {
        ...
        @Override
        public GetAccountLedgerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountLedgerResponse.Builder resBuilder =
            ...
            GetAccountLedgerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountResponse(Utils.unmarshal(response, new TypeReference<AccountResponse>() {}));
                } else {
