...
public class V3ForwardPaymentServiceUserBankAccount {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V3ForwardPaymentServiceUserBankAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ForwardPaymentServiceUserBankAccountRequest.class, new TypeReference<V3ForwardPaymentServiceUserBankAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ForwardPaymentServiceUserBankAccountRequest request) throws Exception {
        ...
        @Override
        public V3ForwardPaymentServiceUserBankAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ForwardPaymentServiceUserBankAccountResponse.Builder resBuilder =
            ...
            V3ForwardPaymentServiceUserBankAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3ForwardPaymentServiceUserBankAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ForwardPaymentServiceUserBankAccountResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
