...
public class ListBankAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBankAccountsRequest request) throws Exception {
        ...
        @Override
        public ListBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BankAccountsCursor out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBankAccountsCursor(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
