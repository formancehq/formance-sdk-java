...
import com.formance.formance_sdk.models.payments.BankAccountsCursor;
...
public class ListBankAccounts {
    ...
    /**
     * LIST_BANK_ACCOUNTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_BANK_ACCOUNTS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBankAccountsRequest, ListBankAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBankAccountsRequest request) {
        ...
        @Override
        public ListBankAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBankAccountsResponse.Builder resBuilder =
            ...
            ListBankAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBankAccountsCursor(Utils.unmarshal(response, new TypeReference<BankAccountsCursor>() {}));
                } else {
