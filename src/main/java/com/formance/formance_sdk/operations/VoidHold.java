...
public class VoidHold {
    
    /**
     * VOID_HOLD_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VOID_HOLD_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<VoidHoldRequest, VoidHoldResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VoidHoldRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VoidHoldRequest.class);
        ...
        public VoidHoldResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            VoidHoldResponse.Builder resBuilder =
                    VoidHoldResponse
                            .builder()
            ...
            VoidHoldResponse res = resBuilder.build();
