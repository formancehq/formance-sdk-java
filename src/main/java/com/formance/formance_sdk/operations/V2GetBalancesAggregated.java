...
public class V2GetBalancesAggregated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetBalancesAggregatedRequest request) throws Exception {
        ...
        @Override
        public V2GetBalancesAggregatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2AggregateBalancesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2AggregateBalancesResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
