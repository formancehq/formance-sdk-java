...
import com.formance.formance_sdk.models.ledger.V2AggregateBalancesResponse;
...
public class V2GetBalancesAggregated {
    
    /**
     * V2_GET_BALANCES_AGGREGATED_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_BALANCES_AGGREGATED_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_GET_BALANCES_AGGREGATED_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V2GetBalancesAggregatedRequest, V2GetBalancesAggregatedResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2GetBalancesAggregatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2GetBalancesAggregatedRequest.class, new TypeReference<V2GetBalancesAggregatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetBalancesAggregatedRequest request) {
        ...
        @Override
        public V2GetBalancesAggregatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetBalancesAggregatedResponse.Builder resBuilder =
            ...
            V2GetBalancesAggregatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2AggregateBalancesResponse(Utils.unmarshal(response, new TypeReference<V2AggregateBalancesResponse>() {}));
                } else {
