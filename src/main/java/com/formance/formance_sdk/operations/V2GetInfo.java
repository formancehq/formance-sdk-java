...
public class V2GetInfo {
    
    /**
     * V2_GET_INFO_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_INFO_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestlessOperation<V2GetInfoResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        public HttpResponse<InputStream> doRequest() {
            ...
            try {
                ...
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "200", "5XX")) {
        ...
        public V2GetInfoResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            V2GetInfoResponse.Builder resBuilder =
                    V2GetInfoResponse
                            .builder()
            ...
            V2GetInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2ConfigInfo(Utils.unmarshal(response, new TypeReference<V2ConfigInfo>() {}));
                } else {
