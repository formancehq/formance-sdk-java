...
public class V2ResetPipeline {
    
    /**
     * V2_RESET_PIPELINE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_RESET_PIPELINE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ResetPipelineRequest, V2ResetPipelineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ResetPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ResetPipelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ResetPipelineRequest request) {
        ...
        @Override
        public V2ResetPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ResetPipelineResponse.Builder resBuilder =
            ...
            V2ResetPipelineResponse res = resBuilder.build();
