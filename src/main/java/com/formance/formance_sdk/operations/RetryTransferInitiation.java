...
public class RetryTransferInitiation {
    
    /**
     * RETRY_TRANSFER_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] RETRY_TRANSFER_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        RETRY_TRANSFER_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<RetryTransferInitiationRequest, RetryTransferInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RetryTransferInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RetryTransferInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RetryTransferInitiationRequest request) {
        ...
        @Override
        public RetryTransferInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RetryTransferInitiationResponse.Builder resBuilder =
            ...
            RetryTransferInitiationResponse res = resBuilder.build();
