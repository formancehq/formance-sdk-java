...
public class ReverseTransferInitiation {
    ...
    /**
     * REVERSE_TRANSFER_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] REVERSE_TRANSFER_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        REVERSE_TRANSFER_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ReverseTransferInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReverseTransferInitiationRequest.class, new TypeReference<ReverseTransferInitiationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReverseTransferInitiationRequest request) {
        ...
        @Override
        public ReverseTransferInitiationResponse handleResponse(HttpResponse<InputStream> response) {
