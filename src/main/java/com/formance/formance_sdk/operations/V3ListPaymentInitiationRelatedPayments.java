...
public class V3ListPaymentInitiationRelatedPayments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentInitiationRelatedPaymentsRequest request) throws Exception {
        ...
        @Override
        public V3ListPaymentInitiationRelatedPaymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3PaymentInitiationRelatedPaymentsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3PaymentInitiationRelatedPaymentsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
