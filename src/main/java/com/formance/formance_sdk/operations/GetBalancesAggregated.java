...
import com.formance.formance_sdk.models.ledger.AggregateBalancesResponse;
...
public class GetBalancesAggregated {
    
    /**
     * GET_BALANCES_AGGREGATED_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_BALANCES_AGGREGATED_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_BALANCES_AGGREGATED_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBalancesAggregatedRequest, GetBalancesAggregatedResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBalancesAggregatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBalancesAggregatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBalancesAggregatedRequest request) {
        ...
        @Override
        public GetBalancesAggregatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBalancesAggregatedResponse.Builder resBuilder =
            ...
            GetBalancesAggregatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAggregateBalancesResponse(Utils.unmarshal(response, new TypeReference<AggregateBalancesResponse>() {}));
                } else {
