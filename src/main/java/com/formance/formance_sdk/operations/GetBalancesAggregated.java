...
public class GetBalancesAggregated {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetBalancesAggregatedRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBalancesAggregatedRequest request) throws Exception {
        ...
        @Override
        public GetBalancesAggregatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AggregateBalancesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAggregateBalancesResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
