...
public class CreatePolicy {
    ...
    /**
     * CREATE_POLICY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CREATE_POLICY_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(PolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PolicyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PolicyRequest request) {
        ...
        @Override
        public CreatePolicyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPolicyResponse(Utils.unmarshal(response, new TypeReference<PolicyResponse>() {}));
                } else {
