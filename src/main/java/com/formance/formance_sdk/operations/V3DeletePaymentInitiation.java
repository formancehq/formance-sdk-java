...
public class V3DeletePaymentInitiation {
    
    /**
     * V3_DELETE_PAYMENT_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_DELETE_PAYMENT_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_DELETE_PAYMENT_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3DeletePaymentInitiationRequest, V3DeletePaymentInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3DeletePaymentInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DeletePaymentInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DeletePaymentInitiationRequest request) {
        ...
        @Override
        public V3DeletePaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DeletePaymentInitiationResponse.Builder resBuilder =
            ...
            V3DeletePaymentInitiationResponse res = resBuilder.build();
