...
public class CreateSecret {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateSecretRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSecretRequest.class, new TypeReference<CreateSecretRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSecretRequest request) throws Exception {
        ...
        @Override
        public CreateSecretResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSecretResponse.Builder resBuilder =
            ...
            CreateSecretResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.CreateSecretResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateSecretResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
