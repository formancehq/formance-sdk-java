...
public class V2ListAccounts {
    
    /**
     * V2_LIST_ACCOUNTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_ACCOUNTS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ListAccountsRequest, V2ListAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ListAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListAccountsRequest.class, new TypeReference<V2ListAccountsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListAccountsRequest request) {
        ...
        @Override
        public V2ListAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ListAccountsResponse.Builder resBuilder =
            ...
            V2ListAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2AccountsCursorResponse(Utils.unmarshal(response, new TypeReference<V2AccountsCursorResponse>() {}));
                } else {
