...
public class ListAccountsPayments {
    
    /**
     * LIST_ACCOUNTS_PAYMENTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_ACCOUNTS_PAYMENTS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        LIST_ACCOUNTS_PAYMENTS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountsPaymentsRequest, ListAccountsPaymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListAccountsPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountsPaymentsRequest.class, new TypeReference<ListAccountsPaymentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountsPaymentsRequest request) {
        ...
        @Override
        public ListAccountsPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountsPaymentsResponse.Builder resBuilder =
            ...
            ListAccountsPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountsCursor(Utils.unmarshal(response, new TypeReference<AccountsCursor>() {}));
                } else {
