...
public class ResolveAlert {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/alerts/{alertID}/resolve",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ResolveAlertRequest, ResolveAlertResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ResolveAlertRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResolveAlertRequest.class, new TypeReference<ResolveAlertRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResolveAlertRequest request) {
        ...
        @Override
        public ResolveAlertResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResolveAlertResponse.Builder resBuilder =
            ...
            ResolveAlertResponse res = resBuilder.build();
