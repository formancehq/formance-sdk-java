...
public class ListConfigsAvailableConnectors {
    
    /**
     * LIST_CONFIGS_AVAILABLE_CONNECTORS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_CONFIGS_AVAILABLE_CONNECTORS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        LIST_CONFIGS_AVAILABLE_CONNECTORS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListConfigsAvailableConnectorsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public ListConfigsAvailableConnectorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListConfigsAvailableConnectorsResponse.Builder resBuilder =
            ...
            ListConfigsAvailableConnectorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectorsConfigsResponse(Utils.unmarshal(response, new TypeReference<ConnectorsConfigsResponse>() {}));
                } else {
