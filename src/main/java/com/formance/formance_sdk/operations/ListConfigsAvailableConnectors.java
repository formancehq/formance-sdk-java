...
public class ListConfigsAvailableConnectors {
    ...
    public static class Sync extends Base
        ...
        @Override
        public ListConfigsAvailableConnectorsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectorsConfigsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectorsConfigsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
