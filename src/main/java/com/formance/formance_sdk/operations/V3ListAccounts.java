...
import com.formance.formance_sdk.models.payments.V3AccountsCursorResponse;
...
public class V3ListAccounts {
    
    /**
     * V3_LIST_ACCOUNTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_ACCOUNTS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListAccountsRequest, V3ListAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListAccountsRequest.class, new TypeReference<V3ListAccountsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListAccountsRequest request) {
        ...
        @Override
        public V3ListAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListAccountsResponse.Builder resBuilder =
            ...
            V3ListAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3AccountsCursorResponse(Utils.unmarshal(response, new TypeReference<V3AccountsCursorResponse>() {}));
                } else {
