...
public class V3ListAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListAccountsRequest request) throws Exception {
        ...
        @Override
        public V3ListAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3AccountsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3AccountsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
