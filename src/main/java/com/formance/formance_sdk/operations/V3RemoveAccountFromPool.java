...
public class V3RemoveAccountFromPool {
    
    /**
     * V3_REMOVE_ACCOUNT_FROM_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_REMOVE_ACCOUNT_FROM_POOL_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_REMOVE_ACCOUNT_FROM_POOL_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3RemoveAccountFromPoolRequest, V3RemoveAccountFromPoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3RemoveAccountFromPoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3RemoveAccountFromPoolRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3RemoveAccountFromPoolRequest request) {
        ...
        @Override
        public V3RemoveAccountFromPoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3RemoveAccountFromPoolResponse.Builder resBuilder =
            ...
            V3RemoveAccountFromPoolResponse res = resBuilder.build();
