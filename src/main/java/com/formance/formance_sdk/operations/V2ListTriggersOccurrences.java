...
public class V2ListTriggersOccurrences {
    
    /**
     * V2_LIST_TRIGGERS_OCCURRENCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_TRIGGERS_OCCURRENCES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_LIST_TRIGGERS_OCCURRENCES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ListTriggersOccurrencesRequest, V2ListTriggersOccurrencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ListTriggersOccurrencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListTriggersOccurrencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListTriggersOccurrencesRequest request) {
        ...
        @Override
        public V2ListTriggersOccurrencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ListTriggersOccurrencesResponse.Builder resBuilder =
            ...
            V2ListTriggersOccurrencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2ListTriggersOccurrencesResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.V2ListTriggersOccurrencesResponse>() {}));
                } else {
