...
public class V2ListTriggersOccurrences {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2ListTriggersOccurrencesRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListTriggersOccurrencesRequest request) throws Exception {
        ...
        @Override
        public V2ListTriggersOccurrencesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2ListTriggersOccurrencesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2ListTriggersOccurrencesResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
