        ...
        public V2ListTriggersOccurrencesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2ListTriggersOccurrencesResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.shared.V2ListTriggersOccurrencesResponse>() {}));
                } else {
