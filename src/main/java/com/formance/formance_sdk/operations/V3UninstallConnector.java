...
public class V3UninstallConnector {
    
    /**
     * V3_UNINSTALL_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_UNINSTALL_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_UNINSTALL_CONNECTOR_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3UninstallConnectorRequest, V3UninstallConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3UninstallConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3UninstallConnectorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3UninstallConnectorRequest request) {
        ...
        @Override
        public V3UninstallConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3UninstallConnectorResponse.Builder resBuilder =
            ...
            V3UninstallConnectorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3UninstallConnectorResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3UninstallConnectorResponse>() {}));
                } else {
