...
public class V3UninstallConnector {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3UninstallConnectorRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3UninstallConnectorRequest request) throws Exception {
        ...
        @Override
        public V3UninstallConnectorResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3UninstallConnectorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3UninstallConnectorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
