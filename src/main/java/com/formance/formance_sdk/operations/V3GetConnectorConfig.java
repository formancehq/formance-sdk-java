...
public class V3GetConnectorConfig {
    
    /**
     * V3_GET_CONNECTOR_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_CONNECTOR_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_CONNECTOR_CONFIG_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetConnectorConfigRequest, V3GetConnectorConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetConnectorConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetConnectorConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetConnectorConfigRequest request) {
        ...
        @Override
        public V3GetConnectorConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetConnectorConfigResponse.Builder resBuilder =
            ...
            V3GetConnectorConfigResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetConnectorConfigResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetConnectorConfigResponse>() {}));
                } else {
