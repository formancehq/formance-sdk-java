...
public class V3GetConnectorConfig {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetConnectorConfigRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetConnectorConfigRequest request) throws Exception {
        ...
        @Override
        public V3GetConnectorConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetConnectorConfigResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetConnectorConfigResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
