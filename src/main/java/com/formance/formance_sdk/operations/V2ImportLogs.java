...
public class V2ImportLogs {
    
    /**
     * V2_IMPORT_LOGS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_IMPORT_LOGS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ImportLogsRequest, V2ImportLogsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ImportLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ImportLogsRequest.class, new TypeReference<V2ImportLogsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ImportLogsRequest request) {
        ...
        @Override
        public V2ImportLogsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ImportLogsResponse.Builder resBuilder =
            ...
            V2ImportLogsResponse res = resBuilder.build();
