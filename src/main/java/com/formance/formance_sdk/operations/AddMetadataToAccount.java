...
public class AddMetadataToAccount {
    
    /**
     * ADD_METADATA_TO_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] ADD_METADATA_TO_ACCOUNT_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        ADD_METADATA_TO_ACCOUNT_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<AddMetadataToAccountRequest, AddMetadataToAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddMetadataToAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMetadataToAccountRequest.class, new TypeReference<AddMetadataToAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddMetadataToAccountRequest request) {
        ...
        @Override
        public AddMetadataToAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddMetadataToAccountResponse.Builder resBuilder =
            ...
            AddMetadataToAccountResponse res = resBuilder.build();
