...
public class RunWorkflow {
    ...
    /**
     * RUN_WORKFLOW_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] RUN_WORKFLOW_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<RunWorkflowRequest, RunWorkflowResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RunWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RunWorkflowRequest.class, new TypeReference<RunWorkflowRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RunWorkflowRequest request) {
        ...
        @Override
        public RunWorkflowResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RunWorkflowResponse.Builder resBuilder =
                    RunWorkflowResponse
                            .builder()
            ...
            RunWorkflowResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRunWorkflowResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.RunWorkflowResponse>() {}));
                } else {
