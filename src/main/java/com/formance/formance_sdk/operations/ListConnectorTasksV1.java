...
public class ListConnectorTasksV1 {
    
    /**
     * LIST_CONNECTOR_TASKS_V1_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_CONNECTOR_TASKS_V1_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        LIST_CONNECTOR_TASKS_V1_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ListConnectorTasksV1Request, ListConnectorTasksV1Response> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListConnectorTasksV1Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListConnectorTasksV1Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListConnectorTasksV1Request request) {
        ...
        @Override
        public ListConnectorTasksV1Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListConnectorTasksV1Response.Builder resBuilder =
            ...
            ListConnectorTasksV1Response res = resBuilder.build();
