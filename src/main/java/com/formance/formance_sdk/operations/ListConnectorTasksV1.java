...
public class ListConnectorTasksV1 {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListConnectorTasksV1Request request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListConnectorTasksV1Request request) throws Exception {
        ...
        @Override
        public ListConnectorTasksV1Response handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TasksCursor out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTasksCursor(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
