...
public class V3GetPoolBalances {
    
    /**
     * V3_GET_POOL_BALANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_POOL_BALANCES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_POOL_BALANCES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetPoolBalancesRequest, V3GetPoolBalancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetPoolBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetPoolBalancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPoolBalancesRequest request) {
        ...
        @Override
        public V3GetPoolBalancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetPoolBalancesResponse.Builder resBuilder =
            ...
            V3GetPoolBalancesResponse res = resBuilder.build();
