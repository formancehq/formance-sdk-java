...
public class GetWorkflow {
    ...
    /**
     * GET_WORKFLOW_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_WORKFLOW_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkflowRequest, GetWorkflowResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkflowRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkflowRequest request) {
        ...
        @Override
        public GetWorkflowResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkflowResponse.Builder resBuilder =
                    GetWorkflowResponse
                            .builder()
            ...
            GetWorkflowResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkflowResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.GetWorkflowResponse>() {}));
                } else {
