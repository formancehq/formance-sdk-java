...
public class GetWorkflow {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetWorkflowRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkflowRequest request) throws Exception {
        ...
        @Override
        public GetWorkflowResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.GetWorkflowResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkflowResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
