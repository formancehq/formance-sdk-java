...
public class V2GetPipelineState {
    ...
    /**
     * V2_GET_PIPELINE_STATE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_PIPELINE_STATE_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_GET_PIPELINE_STATE_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetPipelineStateRequest request) {
        ...
        @Override
        public V2GetPipelineStateResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2GetPipelineStateResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.ledger.V2GetPipelineStateResponse>() {}));
                } else {
