...
import com.formance.formance_sdk.models.ledger.V2LedgerInfoResponse;
...
public class V2GetLedgerInfo {
    
    /**
     * V2_GET_LEDGER_INFO_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_LEDGER_INFO_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2GetLedgerInfoRequest, V2GetLedgerInfoResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2GetLedgerInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2GetLedgerInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetLedgerInfoRequest request) {
        ...
        @Override
        public V2GetLedgerInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetLedgerInfoResponse.Builder resBuilder =
            ...
            V2GetLedgerInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2LedgerInfoResponse(Utils.unmarshal(response, new TypeReference<V2LedgerInfoResponse>() {}));
                } else {
