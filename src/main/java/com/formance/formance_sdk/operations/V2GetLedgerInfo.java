...
public class V2GetLedgerInfo {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetLedgerInfoRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetLedgerInfoRequest request) throws Exception {
        ...
        @Override
        public V2GetLedgerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2LedgerInfoResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2LedgerInfoResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
