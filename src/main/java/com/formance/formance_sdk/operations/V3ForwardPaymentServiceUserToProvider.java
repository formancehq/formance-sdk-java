...
public class V3ForwardPaymentServiceUserToProvider {
    
    /**
     * V3_FORWARD_PAYMENT_SERVICE_USER_TO_PROVIDER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_FORWARD_PAYMENT_SERVICE_USER_TO_PROVIDER_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_FORWARD_PAYMENT_SERVICE_USER_TO_PROVIDER_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ForwardPaymentServiceUserToProviderRequest, V3ForwardPaymentServiceUserToProviderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ForwardPaymentServiceUserToProviderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ForwardPaymentServiceUserToProviderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ForwardPaymentServiceUserToProviderRequest request) {
        ...
        @Override
        public V3ForwardPaymentServiceUserToProviderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ForwardPaymentServiceUserToProviderResponse.Builder resBuilder =
            ...
            V3ForwardPaymentServiceUserToProviderResponse res = resBuilder.build();
