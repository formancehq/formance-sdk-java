...
public class UpdateBankAccountMetadata {
    
    /**
     * UPDATE_BANK_ACCOUNT_METADATA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UPDATE_BANK_ACCOUNT_METADATA_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        UPDATE_BANK_ACCOUNT_METADATA_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateBankAccountMetadataRequest, UpdateBankAccountMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateBankAccountMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateBankAccountMetadataRequest.class, new TypeReference<UpdateBankAccountMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBankAccountMetadataRequest request) {
        ...
        @Override
        public UpdateBankAccountMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateBankAccountMetadataResponse.Builder resBuilder =
            ...
            UpdateBankAccountMetadataResponse res = resBuilder.build();
