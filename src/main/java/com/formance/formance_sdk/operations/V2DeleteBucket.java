...
public class V2DeleteBucket {
    
    /**
     * V2_DELETE_BUCKET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_DELETE_BUCKET_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2DeleteBucketRequest, V2DeleteBucketResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2DeleteBucketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2DeleteBucketRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2DeleteBucketRequest request) {
        ...
        @Override
        public V2DeleteBucketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2DeleteBucketResponse.Builder resBuilder =
            ...
            V2DeleteBucketResponse res = resBuilder.build();
