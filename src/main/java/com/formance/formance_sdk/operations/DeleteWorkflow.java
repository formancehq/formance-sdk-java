...
public class DeleteWorkflow {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteWorkflowRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteWorkflowRequest, DeleteWorkflowResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeleteWorkflowRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteWorkflowRequest request) throws Exception {
        ...
        @Override
        public DeleteWorkflowResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteWorkflowResponse.Builder resBuilder =
            ...
            DeleteWorkflowResponse res = resBuilder.build();
