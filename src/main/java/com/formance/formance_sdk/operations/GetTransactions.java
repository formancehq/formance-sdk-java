...
public class GetTransactions {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetTransactionsRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransactionsRequest request) throws Exception {
        ...
        @Override
        public GetTransactionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.GetTransactionsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetTransactionsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
