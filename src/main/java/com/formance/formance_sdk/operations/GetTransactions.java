...
public class GetTransactions {
    ...
    /**
     * GET_TRANSACTIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_TRANSACTIONS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public GetTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetTransactionsResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.GetTransactionsResponse>() {}));
                } else {
