...
public class V2ReadTrigger {
    
    /**
     * V2_READ_TRIGGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_READ_TRIGGER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ReadTriggerRequest, V2ReadTriggerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ReadTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ReadTriggerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ReadTriggerRequest request) {
        ...
        @Override
        public V2ReadTriggerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ReadTriggerResponse.Builder resBuilder =
            ...
            V2ReadTriggerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2ReadTriggerResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.V2ReadTriggerResponse>() {}));
                } else {
