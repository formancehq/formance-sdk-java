...
import com.formance.formance_sdk.models.ledger.TransactionsCursorResponse;
...
public class ListTransactions {
    ...
    /**
     * LIST_TRANSACTIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_TRANSACTIONS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransactionsRequest, ListTransactionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionsRequest request) {
        ...
        @Override
        public ListTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransactionsResponse.Builder resBuilder =
            ...
            ListTransactionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionsCursorResponse(Utils.unmarshal(response, new TypeReference<TransactionsCursorResponse>() {}));
                } else {
