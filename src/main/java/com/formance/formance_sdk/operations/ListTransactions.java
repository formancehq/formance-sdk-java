...
public class ListTransactions {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListTransactionsRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransactionsRequest request) throws Exception {
        ...
        @Override
        public ListTransactionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TransactionsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTransactionsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
