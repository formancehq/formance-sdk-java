...
public class DeletePool {
    ...
    /**
     * DELETE_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DELETE_POOL_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePoolRequest, DeletePoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePoolRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePoolRequest request) {
        ...
        @Override
        public DeletePoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePoolResponse.Builder resBuilder =
                    DeletePoolResponse
                            .builder()
            ...
            DeletePoolResponse res = resBuilder.build();
