...
public class V2CreateTrigger {
    
    /**
     * V2_CREATE_TRIGGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_CREATE_TRIGGER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        @Override
        public V2CreateTriggerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CreateTriggerResponse.Builder resBuilder =
            ...
            V2CreateTriggerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2CreateTriggerResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.V2CreateTriggerResponse>() {}));
                } else {
