...
public class V2CreateTrigger {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(Optional<? extends V2TriggerData> request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V2TriggerData> request) throws Exception {
        ...
        @Override
        public V2CreateTriggerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2CreateTriggerResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2CreateTriggerResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
