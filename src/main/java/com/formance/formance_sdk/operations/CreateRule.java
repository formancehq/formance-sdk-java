...
public class CreateRule {
    ...
    public static class Sync extends Base
            implements RequestOperation<RuleRequest, CreateRuleResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RuleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<RuleRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RuleRequest request) {
        ...
        @Override
        public CreateRuleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRuleResponse.Builder resBuilder =
                    CreateRuleResponse
                            .builder()
            ...
            CreateRuleResponse res = resBuilder.build();
