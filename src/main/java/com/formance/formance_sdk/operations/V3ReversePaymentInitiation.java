...
public class V3ReversePaymentInitiation {
    
    /**
     * V3_REVERSE_PAYMENT_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_REVERSE_PAYMENT_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_REVERSE_PAYMENT_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ReversePaymentInitiationRequest, V3ReversePaymentInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ReversePaymentInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ReversePaymentInitiationRequest.class, new TypeReference<V3ReversePaymentInitiationRequest>() {});
        ...
        public V3ReversePaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            V3ReversePaymentInitiationResponse.Builder resBuilder =
            ...
            V3ReversePaymentInitiationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ReversePaymentInitiationResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3ReversePaymentInitiationResponse>() {}));
                } else {
