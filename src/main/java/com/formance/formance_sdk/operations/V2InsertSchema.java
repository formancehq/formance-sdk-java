...
public class V2InsertSchema {
    
    /**
     * V2_INSERT_SCHEMA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_INSERT_SCHEMA_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2InsertSchemaRequest, V2InsertSchemaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2InsertSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2InsertSchemaRequest.class, new TypeReference<V2InsertSchemaRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2InsertSchemaRequest request) {
        ...
        @Override
        public V2InsertSchemaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2InsertSchemaResponse.Builder resBuilder =
            ...
            V2InsertSchemaResponse res = resBuilder.build();
