...
public class V2DeleteExporter {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2DeleteExporterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2DeleteExporterRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2DeleteExporterRequest request) throws Exception {
        ...
        @Override
        public V2DeleteExporterResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2DeleteExporterResponse.Builder resBuilder =
            ...
            V2DeleteExporterResponse res = resBuilder.build();
