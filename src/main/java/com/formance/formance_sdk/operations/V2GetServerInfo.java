...
import com.formance.formance_sdk.models.orchestration.V2ServerInfo;
...
public class V2GetServerInfo {
    
    /**
     * V2_GET_SERVER_INFO_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_SERVER_INFO_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestlessOperation<V2GetServerInfoResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public V2GetServerInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetServerInfoResponse.Builder resBuilder =
            ...
            V2GetServerInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2ServerInfo(Utils.unmarshal(response, new TypeReference<V2ServerInfo>() {}));
                } else {
