...
public class V2GetServerInfo {
    ...
    public static class Sync extends Base
        ...
        @Override
        public V2GetServerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2ServerInfo out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2ServerInfo(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
