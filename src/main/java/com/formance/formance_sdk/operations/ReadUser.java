...
public class ReadUser {
    ...
    /**
     * READ_USER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] READ_USER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ReadUserRequest, ReadUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReadUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReadUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadUserRequest request) {
        ...
        @Override
        public ReadUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReadUserResponse.Builder resBuilder =
                    ReadUserResponse
                            .builder()
            ...
            ReadUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReadUserResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.auth.ReadUserResponse>() {}));
                } else {
