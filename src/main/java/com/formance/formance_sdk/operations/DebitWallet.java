...
public class DebitWallet {
    ...
    /**
     * DEBIT_WALLET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEBIT_WALLET_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<DebitWalletRequest, DebitWalletResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DebitWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DebitWalletRequest.class, new TypeReference<DebitWalletRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DebitWalletRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "201", "204")) {
        ...
        @Override
        public DebitWalletResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DebitWalletResponse.Builder resBuilder =
                    DebitWalletResponse
                            .builder()
            ...
            DebitWalletResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDebitWalletResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.DebitWalletResponse>() {}));
                } else {
