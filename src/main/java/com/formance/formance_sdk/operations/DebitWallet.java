...
public class DebitWallet {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DebitWalletRequest request) throws Exception {
        ...
        @Override
        public DebitWalletResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.DebitWalletResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDebitWalletResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
