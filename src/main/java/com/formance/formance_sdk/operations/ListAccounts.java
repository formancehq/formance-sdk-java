...
public class ListAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountsRequest, ListAccountsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountsRequest request) {
        ...
        @Override
        public ListAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountsResponse.Builder resBuilder =
            ...
            ListAccountsResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "default")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw com.formance.formance_sdk.models.errors.ErrorResponse.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
