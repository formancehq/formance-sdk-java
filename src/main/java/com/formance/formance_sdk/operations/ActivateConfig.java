...
public class ActivateConfig {
    ...
    /**
     * ACTIVATE_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] ACTIVATE_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ActivateConfigRequest, ActivateConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ActivateConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ActivateConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ActivateConfigRequest request) {
        ...
        @Override
        public ActivateConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ActivateConfigResponse.Builder resBuilder =
            ...
            ActivateConfigResponse res = resBuilder.build();
