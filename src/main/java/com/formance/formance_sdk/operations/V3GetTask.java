...
public class V3GetTask {
    
    /**
     * V3_GET_TASK_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_TASK_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetTaskRequest, V3GetTaskResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetTaskRequest request) {
        ...
        @Override
        public V3GetTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetTaskResponse.Builder resBuilder =
                    V3GetTaskResponse
                            .builder()
            ...
            V3GetTaskResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetTaskResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetTaskResponse>() {}));
                } else {
