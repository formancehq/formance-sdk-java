...
public class V3GetTask {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetTaskRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetTaskRequest request) throws Exception {
        ...
        @Override
        public V3GetTaskResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetTaskResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetTaskResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
