...
import com.formance.formance_sdk.models.payments.TransferInitiationResponse;
...
public class CreateTransferInitiation {
    
    /**
     * CREATE_TRANSFER_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CREATE_TRANSFER_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        CREATE_TRANSFER_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<TransferInitiationRequest, CreateTransferInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TransferInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TransferInitiationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TransferInitiationRequest request) {
        ...
        @Override
        public CreateTransferInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTransferInitiationResponse.Builder resBuilder =
            ...
            CreateTransferInitiationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransferInitiationResponse(Utils.unmarshal(response, new TypeReference<TransferInitiationResponse>() {}));
                } else {
