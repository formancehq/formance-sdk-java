...
public class CreateTransferInitiation {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TransferInitiationRequest request) throws Exception {
        ...
        @Override
        public CreateTransferInitiationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TransferInitiationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTransferInitiationResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
