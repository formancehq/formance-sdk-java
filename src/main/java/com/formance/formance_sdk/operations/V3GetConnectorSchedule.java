...
public class V3GetConnectorSchedule {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetConnectorScheduleRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetConnectorScheduleRequest request) throws Exception {
        ...
        @Override
        public V3GetConnectorScheduleResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3ConnectorScheduleResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ConnectorScheduleResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
