...
public class EvaluateRule {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "evaluateRule",
                    java.util.Optional.of(java.util.List.of("reconciliation:write")),
                    securitySource());
        }
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/rules/{ruleID}/evaluate",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<EvaluateRuleRequest, EvaluateRuleResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(EvaluateRuleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EvaluateRuleRequest.class, new TypeReference<EvaluateRuleRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EvaluateRuleRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "200", "409")) {
        ...
        @Override
        public EvaluateRuleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EvaluateRuleResponse.Builder resBuilder =
            ...
            EvaluateRuleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEvaluationResponse(Utils.unmarshal(response, new TypeReference<EvaluationResponse>() {}));
                } else {
