...
public class V3GetConversion {
    
    /**
     * V3_GET_CONVERSION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_CONVERSION_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/payments/v3/conversions/{conversionID}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetConversionRequest, V3GetConversionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetConversionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetConversionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetConversionRequest request) {
        ...
        @Override
        public V3GetConversionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetConversionResponse.Builder resBuilder =
            ...
            V3GetConversionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetConversionResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetConversionResponse>() {}));
                } else {
