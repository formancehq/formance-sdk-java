...
public class ListAlerts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAlertsRequest, ListAlertsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAlertsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAlertsRequest.class, new TypeReference<ListAlertsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAlertsRequest request) {
        ...
        @Override
        public ListAlertsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAlertsResponse.Builder resBuilder =
                    ListAlertsResponse
                            .builder()
            ...
            ListAlertsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAlertsCursorResponse(Utils.unmarshal(response, new TypeReference<AlertsCursorResponse>() {}));
                } else {
