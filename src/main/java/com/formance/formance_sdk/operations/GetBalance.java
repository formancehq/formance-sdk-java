...
public class GetBalance {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetBalanceRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetBalanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.GetBalanceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetBalanceResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
