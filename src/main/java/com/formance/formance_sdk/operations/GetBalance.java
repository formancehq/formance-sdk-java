...
public class GetBalance {
    ...
    /**
     * GET_BALANCE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_BALANCE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBalanceRequest, GetBalanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBalanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBalanceRequest request) {
        ...
        @Override
        public GetBalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBalanceResponse.Builder resBuilder =
                    GetBalanceResponse
                            .builder()
            ...
            GetBalanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetBalanceResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.GetBalanceResponse>() {}));
                } else {
