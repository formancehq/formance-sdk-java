...
public class GetConnectorTask {
    
    /**
     * GET_CONNECTOR_TASK_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_CONNECTOR_TASK_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetConnectorTaskRequest, GetConnectorTaskResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetConnectorTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectorTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectorTaskRequest request) {
        ...
        @Override
        public GetConnectorTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetConnectorTaskResponse.Builder resBuilder =
            ...
            GetConnectorTaskResponse res = resBuilder.build();
