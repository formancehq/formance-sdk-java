...
public class GetTransaction {
    ...
    /**
     * GET_TRANSACTION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_TRANSACTION_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransactionRequest, GetTransactionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionRequest.class);
        ...
        public GetTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTransactionResponse.Builder resBuilder =
            ...
            GetTransactionResponse res = resBuilder.build();
