...
public class PaymentslistAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<PaymentslistAccountsRequest, PaymentslistAccountsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PaymentslistAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PaymentslistAccountsRequest.class, new TypeReference<PaymentslistAccountsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PaymentslistAccountsRequest request) throws Exception {
        ...
        @Override
        public PaymentslistAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PaymentslistAccountsResponse.Builder resBuilder =
            ...
            PaymentslistAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountsCursor out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountsCursor(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
