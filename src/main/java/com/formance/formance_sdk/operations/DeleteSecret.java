...
public class DeleteSecret {
    ...
    /**
     * DELETE_SECRET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DELETE_SECRET_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSecretRequest, DeleteSecretResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSecretRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSecretRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSecretRequest request) {
        ...
        @Override
        public DeleteSecretResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSecretResponse.Builder resBuilder =
            ...
            DeleteSecretResponse res = resBuilder.build();
