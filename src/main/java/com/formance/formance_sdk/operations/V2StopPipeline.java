...
public class V2StopPipeline {
    
    /**
     * V2_STOP_PIPELINE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_STOP_PIPELINE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2StopPipelineRequest, V2StopPipelineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2StopPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2StopPipelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2StopPipelineRequest request) {
        ...
        @Override
        public V2StopPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2StopPipelineResponse.Builder resBuilder =
            ...
            V2StopPipelineResponse res = resBuilder.build();
