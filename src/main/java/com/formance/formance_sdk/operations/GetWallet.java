...
public class GetWallet {
    ...
    /**
     * GET_WALLET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_WALLET_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWalletRequest, GetWalletResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWalletRequest.class);
        ...
        public GetWalletResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetWalletResponse.Builder resBuilder =
                    GetWalletResponse
                            .builder()
            ...
            GetWalletResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWalletResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.GetWalletResponse>() {}));
                } else {
