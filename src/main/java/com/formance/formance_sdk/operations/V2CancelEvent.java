...
public class V2CancelEvent {
    
    /**
     * V2_CANCEL_EVENT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_CANCEL_EVENT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2CancelEventRequest, V2CancelEventResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2CancelEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2CancelEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2CancelEventRequest request) {
        ...
        @Override
        public V2CancelEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CancelEventResponse.Builder resBuilder =
            ...
            V2CancelEventResponse res = resBuilder.build();
