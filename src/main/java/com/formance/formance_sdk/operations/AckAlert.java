...
public class AckAlert {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/alerts/{alertID}/ack",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<AckAlertRequest, AckAlertResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AckAlertRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AckAlertRequest.class, new TypeReference<AckAlertRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AckAlertRequest request) {
        ...
        @Override
        public AckAlertResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AckAlertResponse.Builder resBuilder =
                    AckAlertResponse
                            .builder()
            ...
            AckAlertResponse res = resBuilder.build();
