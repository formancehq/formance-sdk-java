...
public class V3CreateBankAccount {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V3CreateBankAccountRequest> request) throws Exception {
        ...
        @Override
        public V3CreateBankAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3CreateBankAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3CreateBankAccountResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
