...
public class CreateBankAccount {
    ...
    /**
     * CREATE_BANK_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CREATE_BANK_ACCOUNT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(BankAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BankAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BankAccountRequest request) {
        ...
        @Override
        public CreateBankAccountResponse handleResponse(HttpResponse<InputStream> response) {
