...
public class DeletePolicy {
    ...
    /**
     * DELETE_POLICY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DELETE_POLICY_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePolicyRequest, DeletePolicyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePolicyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePolicyRequest request) {
        ...
        @Override
        public DeletePolicyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePolicyResponse.Builder resBuilder =
            ...
            DeletePolicyResponse res = resBuilder.build();
