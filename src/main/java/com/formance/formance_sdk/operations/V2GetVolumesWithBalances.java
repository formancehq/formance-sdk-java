...
public class V2GetVolumesWithBalances {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetVolumesWithBalancesRequest request) throws Exception {
        ...
        @Override
        public V2GetVolumesWithBalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2VolumesWithBalanceCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2VolumesWithBalanceCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
