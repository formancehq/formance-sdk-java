...
public class ListTriggers {
    ...
    /**
     * LIST_TRIGGERS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_TRIGGERS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public ListTriggersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTriggersResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.ListTriggersResponse>() {}));
                } else {
