...
public class V3ListPaymentServiceUsers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentServiceUsersRequest request) throws Exception {
        ...
        @Override
        public V3ListPaymentServiceUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3PaymentServiceUsersCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3PaymentServiceUsersCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
