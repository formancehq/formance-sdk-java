...
public class V2DeleteTrigger {
    ...
    /**
     * V2_DELETE_TRIGGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_DELETE_TRIGGER_SERVERS = {
        "http://localhost:8080/",
    };
