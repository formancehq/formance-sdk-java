...
public class InsertConfig {
    ...
    /**
     * INSERT_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] INSERT_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ConfigUser request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ConfigUser>() {});
