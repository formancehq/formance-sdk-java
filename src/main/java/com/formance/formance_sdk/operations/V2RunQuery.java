...
import com.formance.formance_sdk.models.operations.V2RunQueryResponseBody;
...
public class V2RunQuery {
    
    /**
     * V2_RUN_QUERY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_RUN_QUERY_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2RunQueryRequest, V2RunQueryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2RunQueryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2RunQueryRequest.class, new TypeReference<V2RunQueryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2RunQueryRequest request) {
        ...
        @Override
        public V2RunQueryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2RunQueryResponse.Builder resBuilder =
                    V2RunQueryResponse
                            .builder()
            ...
            V2RunQueryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOneOf(Utils.unmarshal(response, new TypeReference<V2RunQueryResponseBody>() {}));
                } else {
