...
public class V3GetPaymentServiceUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetPaymentServiceUserRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPaymentServiceUserRequest request) throws Exception {
        ...
        @Override
        public V3GetPaymentServiceUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetPaymentServiceUserResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetPaymentServiceUserResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
