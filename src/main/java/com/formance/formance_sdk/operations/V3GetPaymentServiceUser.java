...
public class V3GetPaymentServiceUser {
    
    /**
     * V3_GET_PAYMENT_SERVICE_USER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_PAYMENT_SERVICE_USER_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_PAYMENT_SERVICE_USER_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetPaymentServiceUserRequest, V3GetPaymentServiceUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetPaymentServiceUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetPaymentServiceUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPaymentServiceUserRequest request) {
        ...
        @Override
        public V3GetPaymentServiceUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetPaymentServiceUserResponse.Builder resBuilder =
            ...
            V3GetPaymentServiceUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetPaymentServiceUserResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetPaymentServiceUserResponse>() {}));
                } else {
