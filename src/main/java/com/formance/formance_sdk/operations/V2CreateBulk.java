...
public class V2CreateBulk {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2CreateBulkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2CreateBulkRequest.class, new TypeReference<V2CreateBulkRequest>() {});
        ...
        public V2CreateBulkResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            V2CreateBulkResponse.Builder resBuilder =
            ...
            V2CreateBulkResponse res = resBuilder.build();
