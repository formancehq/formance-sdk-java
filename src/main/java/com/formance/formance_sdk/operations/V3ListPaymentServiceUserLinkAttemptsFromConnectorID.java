...
public class V3ListPaymentServiceUserLinkAttemptsFromConnectorID {
    
    /**
     * V3_LIST_PAYMENT_SERVICE_USER_LINK_ATTEMPTS_FROM_CONNECTOR_ID_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_PAYMENT_SERVICE_USER_LINK_ATTEMPTS_FROM_CONNECTOR_ID_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_LIST_PAYMENT_SERVICE_USER_LINK_ATTEMPTS_FROM_CONNECTOR_ID_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest, V3ListPaymentServiceUserLinkAttemptsFromConnectorIDResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest.class, new TypeReference<V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest request) {
        ...
        @Override
        public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListPaymentServiceUserLinkAttemptsFromConnectorIDResponse.Builder resBuilder =
            ...
            V3ListPaymentServiceUserLinkAttemptsFromConnectorIDResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PaymentServiceUserLinkAttemptsCursorResponse(Utils.unmarshal(response, new TypeReference<V3PaymentServiceUserLinkAttemptsCursorResponse>() {}));
                } else {
