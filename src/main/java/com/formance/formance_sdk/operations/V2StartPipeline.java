...
public class V2StartPipeline {
    
    /**
     * V2_START_PIPELINE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_START_PIPELINE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2StartPipelineRequest, V2StartPipelineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2StartPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2StartPipelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2StartPipelineRequest request) {
        ...
        @Override
        public V2StartPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2StartPipelineResponse.Builder resBuilder =
            ...
            V2StartPipelineResponse res = resBuilder.build();
