...
public class ReadConnectorConfigV1 {
    
    /**
     * READ_CONNECTOR_CONFIG_V1_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] READ_CONNECTOR_CONFIG_V1_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        READ_CONNECTOR_CONFIG_V1_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ReadConnectorConfigV1Request, ReadConnectorConfigV1Response> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReadConnectorConfigV1Request request) throws Exception {
            HttpRequest req = buildRequest(request, ReadConnectorConfigV1Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadConnectorConfigV1Request request) {
        ...
        @Override
        public ReadConnectorConfigV1Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReadConnectorConfigV1Response.Builder resBuilder =
            ...
            ReadConnectorConfigV1Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectorConfigResponse(Utils.unmarshal(response, new TypeReference<ConnectorConfigResponse>() {}));
                } else {
