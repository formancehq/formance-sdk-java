...
public class ReadConnectorConfigV1 {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ReadConnectorConfigV1Request request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadConnectorConfigV1Request request) throws Exception {
        ...
        @Override
        public ReadConnectorConfigV1Response handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectorConfigResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectorConfigResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
