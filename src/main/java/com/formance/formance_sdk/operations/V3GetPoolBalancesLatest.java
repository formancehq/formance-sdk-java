...
import com.formance.formance_sdk.models.payments.V3PoolBalancesResponse;
...
public class V3GetPoolBalancesLatest {
    
    /**
     * V3_GET_POOL_BALANCES_LATEST_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_POOL_BALANCES_LATEST_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_POOL_BALANCES_LATEST_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetPoolBalancesLatestRequest, V3GetPoolBalancesLatestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetPoolBalancesLatestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetPoolBalancesLatestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPoolBalancesLatestRequest request) {
        ...
        @Override
        public V3GetPoolBalancesLatestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetPoolBalancesLatestResponse.Builder resBuilder =
            ...
            V3GetPoolBalancesLatestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PoolBalancesResponse(Utils.unmarshal(response, new TypeReference<V3PoolBalancesResponse>() {}));
                } else {
