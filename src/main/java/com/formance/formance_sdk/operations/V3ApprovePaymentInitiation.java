...
public class V3ApprovePaymentInitiation {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3ApprovePaymentInitiationRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ApprovePaymentInitiationRequest request) throws Exception {
        ...
        @Override
        public V3ApprovePaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3ApprovePaymentInitiationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ApprovePaymentInitiationResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
