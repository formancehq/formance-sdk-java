...
public class V3ApprovePaymentInitiation {
    
    /**
     * V3_APPROVE_PAYMENT_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_APPROVE_PAYMENT_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_APPROVE_PAYMENT_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ApprovePaymentInitiationRequest, V3ApprovePaymentInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ApprovePaymentInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ApprovePaymentInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ApprovePaymentInitiationRequest request) {
        ...
        @Override
        public V3ApprovePaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ApprovePaymentInitiationResponse.Builder resBuilder =
            ...
            V3ApprovePaymentInitiationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ApprovePaymentInitiationResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3ApprovePaymentInitiationResponse>() {}));
                } else {
