...
public class UninstallConnector {
    
    /**
     * UNINSTALL_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UNINSTALL_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<UninstallConnectorRequest, UninstallConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UninstallConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UninstallConnectorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UninstallConnectorRequest request) {
        ...
        @Override
        public UninstallConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UninstallConnectorResponse.Builder resBuilder =
            ...
            UninstallConnectorResponse res = resBuilder.build();
