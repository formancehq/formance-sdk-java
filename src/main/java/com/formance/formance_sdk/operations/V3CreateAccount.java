...
public class V3CreateAccount {
    ...
    /**
     * V3_CREATE_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_CREATE_ACCOUNT_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public V3CreateAccountResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3CreateAccountResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3CreateAccountResponse>() {}));
                } else {
