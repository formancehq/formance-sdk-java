...
public class GetAccountBalances {
    ...
    /**
     * GET_ACCOUNT_BALANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_ACCOUNT_BALANCES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_ACCOUNT_BALANCES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountBalancesRequest, GetAccountBalancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAccountBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountBalancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountBalancesRequest request) {
        ...
        @Override
        public GetAccountBalancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountBalancesResponse.Builder resBuilder =
            ...
            GetAccountBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBalancesCursor(Utils.unmarshal(response, new TypeReference<BalancesCursor>() {}));
                } else {
