...
public class GetAccountBalances {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetAccountBalancesRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountBalancesRequest request) throws Exception {
        ...
        @Override
        public GetAccountBalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BalancesCursor out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBalancesCursor(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
