...
public class Reconcile {
    ...
    /**
     * RECONCILE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] RECONCILE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ReconcileRequest, ReconcileResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReconcileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReconcileRequest.class, new TypeReference<ReconcileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReconcileRequest request) {
        ...
        @Override
        public ReconcileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReconcileResponse.Builder resBuilder =
                    ReconcileResponse
                            .builder()
            ...
            ReconcileResponse res = resBuilder.build();
