...
public class V2ReadStats {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2ReadStatsRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ReadStatsRequest request) throws Exception {
        ...
        @Override
        public V2ReadStatsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2StatsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2StatsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
