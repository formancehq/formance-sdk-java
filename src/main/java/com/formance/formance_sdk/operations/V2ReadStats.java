...
import com.formance.formance_sdk.models.ledger.V2StatsResponse;
...
public class V2ReadStats {
    
    /**
     * V2_READ_STATS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_READ_STATS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ReadStatsRequest, V2ReadStatsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ReadStatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ReadStatsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ReadStatsRequest request) {
        ...
        @Override
        public V2ReadStatsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ReadStatsResponse.Builder resBuilder =
                    V2ReadStatsResponse
                            .builder()
            ...
            V2ReadStatsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2StatsResponse(Utils.unmarshal(response, new TypeReference<V2StatsResponse>() {}));
                } else {
