...
public class V2GetLedger {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetLedgerRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetLedgerRequest request) throws Exception {
        ...
        @Override
        public V2GetLedgerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2GetLedgerResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2GetLedgerResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
