...
public class V2GetLedger {
    
    /**
     * V2_GET_LEDGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_LEDGER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2GetLedgerRequest, V2GetLedgerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2GetLedgerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2GetLedgerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetLedgerRequest request) {
        ...
        @Override
        public V2GetLedgerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetLedgerResponse.Builder resBuilder =
                    V2GetLedgerResponse
                            .builder()
            ...
            V2GetLedgerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2GetLedgerResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.ledger.V2GetLedgerResponse>() {}));
                } else {
