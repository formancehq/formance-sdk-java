...
public class V3ListPools {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPoolsRequest request) throws Exception {
        ...
        @Override
        public V3ListPoolsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3PoolsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3PoolsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
