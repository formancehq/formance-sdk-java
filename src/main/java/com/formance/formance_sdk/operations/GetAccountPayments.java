...
public class GetAccountPayments {
    ...
    /**
     * GET_ACCOUNT_PAYMENTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_ACCOUNT_PAYMENTS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_ACCOUNT_PAYMENTS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountPaymentsRequest, GetAccountPaymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAccountPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountPaymentsRequest request) {
        ...
        @Override
        public GetAccountPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountPaymentsResponse.Builder resBuilder =
            ...
            GetAccountPaymentsResponse res = resBuilder.build();
