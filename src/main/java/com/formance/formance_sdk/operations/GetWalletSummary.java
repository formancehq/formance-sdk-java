...
public class GetWalletSummary {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetWalletSummaryRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWalletSummaryRequest request) throws Exception {
        ...
        @Override
        public GetWalletSummaryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.GetWalletSummaryResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWalletSummaryResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
