...
public class GetWalletSummary {
    
    /**
     * GET_WALLET_SUMMARY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_WALLET_SUMMARY_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWalletSummaryRequest, GetWalletSummaryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWalletSummaryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWalletSummaryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWalletSummaryRequest request) {
        ...
        @Override
        public GetWalletSummaryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWalletSummaryResponse.Builder resBuilder =
            ...
            GetWalletSummaryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWalletSummaryResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.GetWalletSummaryResponse>() {}));
                } else {
