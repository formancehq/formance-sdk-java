...
public class ListClients {
    ...
    /**
     * LIST_CLIENTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_CLIENTS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        @Override
        public ListClientsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClientsResponse.Builder resBuilder =
                    ListClientsResponse
                            .builder()
            ...
            ListClientsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListClientsResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.auth.ListClientsResponse>() {}));
                } else {
