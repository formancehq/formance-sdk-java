...
public class UpdateMetadata {
    ...
    /**
     * UPDATE_METADATA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UPDATE_METADATA_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMetadataRequest, UpdateMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMetadataRequest.class, new TypeReference<UpdateMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMetadataRequest request) {
        ...
        @Override
        public UpdateMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMetadataResponse.Builder resBuilder =
            ...
            UpdateMetadataResponse res = resBuilder.build();
