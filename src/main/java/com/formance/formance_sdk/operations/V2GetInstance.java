...
public class V2GetInstance {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetInstanceRequest request) throws Exception {
        ...
        @Override
        public V2GetInstanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2GetWorkflowInstanceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2GetWorkflowInstanceResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
