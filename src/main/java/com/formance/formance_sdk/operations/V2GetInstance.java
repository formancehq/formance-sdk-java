...
public class V2GetInstance {
    ...
    /**
     * V2_GET_INSTANCE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_INSTANCE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetInstanceRequest request) {
        ...
        @Override
        public V2GetInstanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetInstanceResponse.Builder resBuilder =
            ...
            V2GetInstanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2GetWorkflowInstanceResponse(Utils.unmarshal(response, new TypeReference<V2GetWorkflowInstanceResponse>() {}));
                } else {
