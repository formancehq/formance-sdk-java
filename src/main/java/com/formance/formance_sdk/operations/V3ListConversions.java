...
public class V3ListConversions {
    
    /**
     * V3_LIST_CONVERSIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_CONVERSIONS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListConversionsRequest, V3ListConversionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListConversionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListConversionsRequest.class, new TypeReference<V3ListConversionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListConversionsRequest request) {
        ...
        @Override
        public V3ListConversionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListConversionsResponse.Builder resBuilder =
            ...
            V3ListConversionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ConversionsCursorResponse(Utils.unmarshal(response, new TypeReference<V3ConversionsCursorResponse>() {}));
                } else {
