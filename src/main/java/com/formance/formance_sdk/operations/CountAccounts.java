...
public class CountAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CountAccountsRequest request) throws Exception {
        ...
        @Override
        public CountAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CountAccountsResponse.Builder resBuilder =
