...
public class GetServerInfoOrchestration {
    
    /**
     * GET_SERVER_INFO_ORCHESTRATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_SERVER_INFO_ORCHESTRATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_SERVER_INFO_ORCHESTRATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetServerInfoOrchestrationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public GetServerInfoOrchestrationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetServerInfoOrchestrationResponse.Builder resBuilder =
            ...
            GetServerInfoOrchestrationResponse res = resBuilder.build();
