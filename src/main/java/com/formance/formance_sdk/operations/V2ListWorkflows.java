...
public class V2ListWorkflows {
    
    /**
     * V2_LIST_WORKFLOWS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_WORKFLOWS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ListWorkflowsRequest, V2ListWorkflowsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ListWorkflowsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListWorkflowsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListWorkflowsRequest request) {
        ...
        @Override
        public V2ListWorkflowsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ListWorkflowsResponse.Builder resBuilder =
            ...
            V2ListWorkflowsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2ListWorkflowsResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.V2ListWorkflowsResponse>() {}));
                } else {
