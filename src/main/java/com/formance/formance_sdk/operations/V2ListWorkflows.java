...
public class V2ListWorkflows {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2ListWorkflowsRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListWorkflowsRequest request) throws Exception {
        ...
        @Override
        public V2ListWorkflowsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2ListWorkflowsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2ListWorkflowsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
