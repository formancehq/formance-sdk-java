...
public class V3ListPaymentInitiationAdjustments {
    
    /**
     * V3_LIST_PAYMENT_INITIATION_ADJUSTMENTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_PAYMENT_INITIATION_ADJUSTMENTS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_LIST_PAYMENT_INITIATION_ADJUSTMENTS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListPaymentInitiationAdjustmentsRequest, V3ListPaymentInitiationAdjustmentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        public V3ListPaymentInitiationAdjustmentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            V3ListPaymentInitiationAdjustmentsResponse.Builder resBuilder =
            ...
            V3ListPaymentInitiationAdjustmentsResponse res = resBuilder.build();
