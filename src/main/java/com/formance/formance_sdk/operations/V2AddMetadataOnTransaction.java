...
public class V2AddMetadataOnTransaction {
    ...
    /**
     * V2_ADD_METADATA_ON_TRANSACTION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_ADD_METADATA_ON_TRANSACTION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_ADD_METADATA_ON_TRANSACTION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2AddMetadataOnTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2AddMetadataOnTransactionRequest.class, new TypeReference<V2AddMetadataOnTransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2AddMetadataOnTransactionRequest request) {
        ...
        @Override
        public V2AddMetadataOnTransactionResponse handleResponse(HttpResponse<InputStream> response) {
