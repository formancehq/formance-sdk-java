...
public class V2DeleteWorkflow {
    
    /**
     * V2_DELETE_WORKFLOW_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_DELETE_WORKFLOW_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2DeleteWorkflowRequest, V2DeleteWorkflowResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2DeleteWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2DeleteWorkflowRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2DeleteWorkflowRequest request) {
        ...
        @Override
        public V2DeleteWorkflowResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2DeleteWorkflowResponse.Builder resBuilder =
            ...
            V2DeleteWorkflowResponse res = resBuilder.build();
