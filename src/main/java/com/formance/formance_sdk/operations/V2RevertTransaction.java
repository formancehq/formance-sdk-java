...
import com.formance.formance_sdk.models.ledger.V2CreateTransactionResponse;
...
public class V2RevertTransaction {
    ...
    /**
     * V2_REVERT_TRANSACTION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_REVERT_TRANSACTION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_REVERT_TRANSACTION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2RevertTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2RevertTransactionRequest.class, new TypeReference<V2RevertTransactionRequest>() {});
        ...
        public V2RevertTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2CreateTransactionResponse(Utils.unmarshal(response, new TypeReference<V2CreateTransactionResponse>() {}));
                } else {
