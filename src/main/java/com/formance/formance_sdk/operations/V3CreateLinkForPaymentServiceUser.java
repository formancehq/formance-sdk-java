...
public class V3CreateLinkForPaymentServiceUser {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V3CreateLinkForPaymentServiceUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3CreateLinkForPaymentServiceUserRequest.class, new TypeReference<V3CreateLinkForPaymentServiceUserRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3CreateLinkForPaymentServiceUserRequest request) {
        ...
        @Override
        public V3CreateLinkForPaymentServiceUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3CreateLinkForPaymentServiceUserResponse.Builder resBuilder =
            ...
            V3CreateLinkForPaymentServiceUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PaymentServiceUserCreateLinkResponse(Utils.unmarshal(response, new TypeReference<V3PaymentServiceUserCreateLinkResponse>() {}));
                } else {
