...
public class V2CountTransactions {
    
    /**
     * V2_COUNT_TRANSACTIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_COUNT_TRANSACTIONS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_COUNT_TRANSACTIONS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V2CountTransactionsRequest, V2CountTransactionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2CountTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2CountTransactionsRequest.class, new TypeReference<V2CountTransactionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2CountTransactionsRequest request) {
        ...
        @Override
        public V2CountTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CountTransactionsResponse.Builder resBuilder =
            ...
            V2CountTransactionsResponse res = resBuilder.build();
