...
public class PatchRule {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/rules/{ruleID}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRuleRequest, PatchRuleResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRuleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRuleRequest.class, new TypeReference<PatchRuleRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRuleRequest request) {
        ...
        @Override
        public PatchRuleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRuleResponse.Builder resBuilder =
                    PatchRuleResponse
                            .builder()
            ...
            PatchRuleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRuleResponse(Utils.unmarshal(response, new TypeReference<RuleResponse>() {}));
                } else {
