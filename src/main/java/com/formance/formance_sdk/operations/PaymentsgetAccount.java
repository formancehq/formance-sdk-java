...
public class PaymentsgetAccount {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(PaymentsgetAccountRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PaymentsgetAccountRequest request) throws Exception {
        ...
        @Override
        public PaymentsgetAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentsAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentsAccountResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
