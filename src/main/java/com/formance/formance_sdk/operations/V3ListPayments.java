...
public class V3ListPayments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentsRequest request) throws Exception {
        ...
        @Override
        public V3ListPaymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3PaymentsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3PaymentsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
