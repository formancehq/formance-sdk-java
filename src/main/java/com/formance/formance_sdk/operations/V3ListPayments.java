...
import com.formance.formance_sdk.models.payments.V3PaymentsCursorResponse;
...
public class V3ListPayments {
    ...
    /**
     * V3_LIST_PAYMENTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_PAYMENTS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V3ListPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListPaymentsRequest.class, new TypeReference<V3ListPaymentsRequest>() {});
