...
public class AcceptAlert {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/alerts/{alertID}/accept",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<AcceptAlertRequest, AcceptAlertResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AcceptAlertRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AcceptAlertRequest.class, new TypeReference<AcceptAlertRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AcceptAlertRequest request) {
        ...
        @Override
        public AcceptAlertResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AcceptAlertResponse.Builder resBuilder =
                    AcceptAlertResponse
                            .builder()
            ...
            AcceptAlertResponse res = resBuilder.build();
