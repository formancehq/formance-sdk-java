...
public class V3GetAccountBalances {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetAccountBalancesRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetAccountBalancesRequest request) throws Exception {
        ...
        @Override
        public V3GetAccountBalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3BalancesCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3BalancesCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
