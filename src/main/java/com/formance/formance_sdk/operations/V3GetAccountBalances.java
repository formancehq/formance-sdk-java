...
public class V3GetAccountBalances {
    
    /**
     * V3_GET_ACCOUNT_BALANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_ACCOUNT_BALANCES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_ACCOUNT_BALANCES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetAccountBalancesRequest, V3GetAccountBalancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetAccountBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetAccountBalancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetAccountBalancesRequest request) {
        ...
        @Override
        public V3GetAccountBalancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetAccountBalancesResponse.Builder resBuilder =
            ...
            V3GetAccountBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3BalancesCursorResponse(Utils.unmarshal(response, new TypeReference<V3BalancesCursorResponse>() {}));
                } else {
