...
public class DeleteConfig {
    ...
    /**
     * DELETE_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DELETE_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteConfigRequest, DeleteConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteConfigRequest request) {
        ...
        @Override
        public DeleteConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteConfigResponse.Builder resBuilder =
            ...
            DeleteConfigResponse res = resBuilder.build();
