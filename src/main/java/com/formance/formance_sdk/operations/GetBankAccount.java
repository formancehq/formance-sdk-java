...
public class GetBankAccount {
    ...
    /**
     * GET_BANK_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_BANK_ACCOUNT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBankAccountRequest, GetBankAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBankAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBankAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBankAccountRequest request) {
        ...
        @Override
        public GetBankAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBankAccountResponse.Builder resBuilder =
            ...
            GetBankAccountResponse res = resBuilder.build();
