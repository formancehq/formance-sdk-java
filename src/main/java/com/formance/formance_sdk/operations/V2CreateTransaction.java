...
public class V2CreateTransaction {
    
    /**
     * V2_CREATE_TRANSACTION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_CREATE_TRANSACTION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_CREATE_TRANSACTION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V2CreateTransactionRequest, V2CreateTransactionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2CreateTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2CreateTransactionRequest.class, new TypeReference<V2CreateTransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2CreateTransactionRequest request) {
        ...
        @Override
        public V2CreateTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CreateTransactionResponse.Builder resBuilder =
            ...
            V2CreateTransactionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2CreateTransactionResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.ledger.V2CreateTransactionResponse>() {}));
                } else {
