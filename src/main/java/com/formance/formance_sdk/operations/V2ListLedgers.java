...
public class V2ListLedgers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListLedgersRequest request) throws Exception {
        ...
        @Override
        public V2ListLedgersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2LedgerListResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2LedgerListResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
