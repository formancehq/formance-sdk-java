...
public class V2ListLedgers {
    
    /**
     * V2_LIST_LEDGERS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_LEDGERS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ListLedgersRequest, V2ListLedgersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ListLedgersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListLedgersRequest.class, new TypeReference<V2ListLedgersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListLedgersRequest request) {
        ...
        @Override
        public V2ListLedgersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ListLedgersResponse.Builder resBuilder =
            ...
            V2ListLedgersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2LedgerListResponse(Utils.unmarshal(response, new TypeReference<V2LedgerListResponse>() {}));
                } else {
