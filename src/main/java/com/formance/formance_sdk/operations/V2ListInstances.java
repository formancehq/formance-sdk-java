...
public class V2ListInstances {
    ...
    /**
     * V2_LIST_INSTANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_INSTANCES_SERVERS = {
        "http://localhost:8080/",
    };
