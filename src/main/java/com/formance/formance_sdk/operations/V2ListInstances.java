...
public class V2ListInstances {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2ListInstancesRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListInstancesRequest request) throws Exception {
        ...
        @Override
        public V2ListInstancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2ListRunsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2ListRunsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
