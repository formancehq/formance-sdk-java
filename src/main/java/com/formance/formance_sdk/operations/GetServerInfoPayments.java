...
public class GetServerInfoPayments {
    
    /**
     * GET_SERVER_INFO_PAYMENTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_SERVER_INFO_PAYMENTS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_SERVER_INFO_PAYMENTS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetServerInfoPaymentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public GetServerInfoPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetServerInfoPaymentsResponse.Builder resBuilder =
            ...
            GetServerInfoPaymentsResponse res = resBuilder.build();
