...
public class V3AddAccountToPool {
    
    /**
     * V3_ADD_ACCOUNT_TO_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_ADD_ACCOUNT_TO_POOL_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_ADD_ACCOUNT_TO_POOL_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3AddAccountToPoolRequest, V3AddAccountToPoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3AddAccountToPoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3AddAccountToPoolRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3AddAccountToPoolRequest request) {
        ...
        @Override
        public V3AddAccountToPoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3AddAccountToPoolResponse.Builder resBuilder =
            ...
            V3AddAccountToPoolResponse res = resBuilder.build();
