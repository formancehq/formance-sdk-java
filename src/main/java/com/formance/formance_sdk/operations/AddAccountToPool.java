...
public class AddAccountToPool {
    ...
    /**
     * ADD_ACCOUNT_TO_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] ADD_ACCOUNT_TO_POOL_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AddAccountToPoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddAccountToPoolRequest.class, new TypeReference<AddAccountToPoolRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddAccountToPoolRequest request) {
        ...
        @Override
        public AddAccountToPoolResponse handleResponse(HttpResponse<InputStream> response) {
