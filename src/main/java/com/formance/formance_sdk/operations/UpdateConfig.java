...
public class UpdateConfig {
    ...
    /**
     * UPDATE_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UPDATE_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateConfigRequest, UpdateConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateConfigRequest.class, new TypeReference<UpdateConfigRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateConfigRequest request) {
        ...
        @Override
        public UpdateConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateConfigResponse.Builder resBuilder =
            ...
            UpdateConfigResponse res = resBuilder.build();
