...
public class CountTransactions {
    ...
    /**
     * COUNT_TRANSACTIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] COUNT_TRANSACTIONS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<CountTransactionsRequest, CountTransactionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CountTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CountTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CountTransactionsRequest request) {
        ...
        @Override
        public CountTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CountTransactionsResponse.Builder resBuilder =
            ...
            CountTransactionsResponse res = resBuilder.build();
