...
public class V2CreateLedger {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2CreateLedgerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2CreateLedgerRequest.class, new TypeReference<V2CreateLedgerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2CreateLedgerRequest request) throws Exception {
        ...
        @Override
        public V2CreateLedgerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CreateLedgerResponse.Builder resBuilder =
            ...
            V2CreateLedgerResponse res = resBuilder.build();
