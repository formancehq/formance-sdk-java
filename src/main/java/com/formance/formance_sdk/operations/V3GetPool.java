...
public class V3GetPool {
    
    /**
     * V3_GET_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_POOL_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetPoolRequest, V3GetPoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetPoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetPoolRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPoolRequest request) {
        ...
        @Override
        public V3GetPoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetPoolResponse.Builder resBuilder =
                    V3GetPoolResponse
                            .builder()
            ...
            V3GetPoolResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetPoolResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetPoolResponse>() {}));
                } else {
