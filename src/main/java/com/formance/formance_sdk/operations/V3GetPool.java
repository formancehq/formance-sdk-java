...
public class V3GetPool {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetPoolRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPoolRequest request) throws Exception {
        ...
        @Override
        public V3GetPoolResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetPoolResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetPoolResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
