...
public class V3CreatePool {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V3CreatePoolRequest> request) throws Exception {
        ...
        @Override
        public V3CreatePoolResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3CreatePoolResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3CreatePoolResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
