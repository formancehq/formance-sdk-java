...
import com.formance.formance_sdk.models.ledger.ScriptResponse;
...
public class RunScript {
    ...
    /**
     * RUN_SCRIPT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] RUN_SCRIPT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(RunScriptRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RunScriptRequest.class, new TypeReference<RunScriptRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RunScriptRequest request) {
        ...
        @Override
        public RunScriptResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScriptResponse(Utils.unmarshal(response, new TypeReference<ScriptResponse>() {}));
                } else {
