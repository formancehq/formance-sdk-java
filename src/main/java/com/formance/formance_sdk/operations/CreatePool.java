...
public class CreatePool {
    ...
    /**
     * CREATE_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CREATE_POOL_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<PoolRequest, CreatePoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PoolRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PoolRequest request) {
        ...
        @Override
        public CreatePoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePoolResponse.Builder resBuilder =
                    CreatePoolResponse
                            .builder()
            ...
            CreatePoolResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPoolResponse(Utils.unmarshal(response, new TypeReference<PoolResponse>() {}));
                } else {
