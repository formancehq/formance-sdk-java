...
public class OrchestrationgetServerInfo {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<OrchestrationgetServerInfoResponse> {
        ...
        @Override
        public OrchestrationgetServerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OrchestrationgetServerInfoResponse.Builder resBuilder =
            ...
            OrchestrationgetServerInfoResponse res = resBuilder.build();
