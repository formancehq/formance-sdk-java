...
public class V3GetBankAccount {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetBankAccountRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetBankAccountRequest request) throws Exception {
        ...
        @Override
        public V3GetBankAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetBankAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetBankAccountResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
