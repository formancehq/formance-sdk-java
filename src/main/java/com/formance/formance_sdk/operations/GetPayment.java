...
public class GetPayment {
    ...
    /**
     * GET_PAYMENT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_PAYMENT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentRequest, GetPaymentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentRequest request) {
        ...
        @Override
        public GetPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentResponse.Builder resBuilder =
                    GetPaymentResponse
                            .builder()
            ...
            GetPaymentResponse res = resBuilder.build();
