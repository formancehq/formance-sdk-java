...
public class ReplayDeliveries {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplayDeliveriesRequest, ReplayDeliveriesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ReplayDeliveriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ReplayDeliveriesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplayDeliveriesRequest request) {
        ...
        @Override
        public ReplayDeliveriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplayDeliveriesResponse.Builder resBuilder =
            ...
            ReplayDeliveriesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReplayDeliveriesResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.webhooks.ReplayDeliveriesResponse>() {}));
                } else {
