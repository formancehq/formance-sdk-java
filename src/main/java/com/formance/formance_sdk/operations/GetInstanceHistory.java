...
import com.formance.formance_sdk.models.orchestration.GetWorkflowInstanceHistoryResponse;
...
public class GetInstanceHistory {
    ...
    /**
     * GET_INSTANCE_HISTORY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_INSTANCE_HISTORY_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_INSTANCE_HISTORY_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetInstanceHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInstanceHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInstanceHistoryRequest request) {
        ...
        @Override
        public GetInstanceHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkflowInstanceHistoryResponse(Utils.unmarshal(response, new TypeReference<GetWorkflowInstanceHistoryResponse>() {}));
                } else {
