...
public class SendEvent {
    ...
    /**
     * SEND_EVENT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] SEND_EVENT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<SendEventRequest, SendEventResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SendEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SendEventRequest.class, new TypeReference<SendEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SendEventRequest request) {
        ...
        @Override
        public SendEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SendEventResponse.Builder resBuilder =
                    SendEventResponse
                            .builder()
            ...
            SendEventResponse res = resBuilder.build();
