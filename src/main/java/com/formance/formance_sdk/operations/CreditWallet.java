...
public class CreditWallet {
    ...
    /**
     * CREDIT_WALLET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CREDIT_WALLET_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<CreditWalletRequest, CreditWalletResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreditWalletRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreditWalletRequest.class, new TypeReference<CreditWalletRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreditWalletRequest request) {
        ...
        @Override
        public CreditWalletResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreditWalletResponse.Builder resBuilder =
            ...
            CreditWalletResponse res = resBuilder.build();
