...
public class ListRules {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRulesRequest, ListRulesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRulesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRulesRequest.class, new TypeReference<ListRulesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRulesRequest request) {
        ...
        @Override
        public ListRulesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRulesResponse.Builder resBuilder =
                    ListRulesResponse
                            .builder()
            ...
            ListRulesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRulesCursorResponse(Utils.unmarshal(response, new TypeReference<RulesCursorResponse>() {}));
                } else {
