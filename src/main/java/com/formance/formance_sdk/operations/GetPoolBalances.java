...
import com.formance.formance_sdk.models.payments.PoolBalancesResponse;
...
public class GetPoolBalances {
    
    /**
     * GET_POOL_BALANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_POOL_BALANCES_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPoolBalancesRequest, GetPoolBalancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPoolBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPoolBalancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPoolBalancesRequest request) {
        ...
        @Override
        public GetPoolBalancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPoolBalancesResponse.Builder resBuilder =
            ...
            GetPoolBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPoolBalancesResponse(Utils.unmarshal(response, new TypeReference<PoolBalancesResponse>() {}));
                } else {
