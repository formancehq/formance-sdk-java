...
public class GetDelivery {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeliveryRequest, GetDeliveryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeliveryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeliveryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeliveryRequest request) {
        ...
        @Override
        public GetDeliveryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeliveryResponse.Builder resBuilder =
                    GetDeliveryResponse
                            .builder()
            ...
            GetDeliveryResponse res = resBuilder.build();
