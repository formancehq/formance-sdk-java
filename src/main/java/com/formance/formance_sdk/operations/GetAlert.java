...
public class GetAlert {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/alerts/{alertID}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAlertRequest, GetAlertResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAlertRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAlertRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAlertRequest request) {
        ...
        @Override
        public GetAlertResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAlertResponse.Builder resBuilder =
                    GetAlertResponse
                            .builder()
            ...
            GetAlertResponse res = resBuilder.build();
