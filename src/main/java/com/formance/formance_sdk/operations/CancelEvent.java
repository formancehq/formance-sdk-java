...
public class CancelEvent {
    ...
    /**
     * CANCEL_EVENT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CANCEL_EVENT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelEventRequest, CancelEventResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelEventRequest request) {
        ...
        @Override
        public CancelEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelEventResponse.Builder resBuilder =
                    CancelEventResponse
                            .builder()
            ...
            CancelEventResponse res = resBuilder.build();
