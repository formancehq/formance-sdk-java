...
public class V3ListConnectorConfigs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public V3ListConnectorConfigsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3ConnectorConfigsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ConnectorConfigsResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
