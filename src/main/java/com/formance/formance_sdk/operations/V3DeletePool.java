...
public class V3DeletePool {
    
    /**
     * V3_DELETE_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_DELETE_POOL_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3DeletePoolRequest, V3DeletePoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3DeletePoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DeletePoolRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DeletePoolRequest request) {
        ...
        @Override
        public V3DeletePoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DeletePoolResponse.Builder resBuilder =
            ...
            V3DeletePoolResponse res = resBuilder.build();
