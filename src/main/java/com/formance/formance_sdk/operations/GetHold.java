...
public class GetHold {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetHoldRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHoldRequest request) throws Exception {
        ...
        @Override
        public GetHoldResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.GetHoldResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetHoldResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
