...
public class GetHold {
    ...
    /**
     * GET_HOLD_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_HOLD_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHoldRequest, GetHoldResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetHoldRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHoldRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHoldRequest request) {
        ...
        @Override
        public GetHoldResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHoldResponse.Builder resBuilder =
                    GetHoldResponse
                            .builder()
            ...
            GetHoldResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetHoldResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.GetHoldResponse>() {}));
                } else {
