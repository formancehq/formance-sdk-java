...
public class GetLedgerInfo {
    ...
    /**
     * GET_LEDGER_INFO_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_LEDGER_INFO_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLedgerInfoRequest, GetLedgerInfoResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLedgerInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLedgerInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLedgerInfoRequest request) {
        ...
        @Override
        public GetLedgerInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLedgerInfoResponse.Builder resBuilder =
            ...
            GetLedgerInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLedgerInfoResponse(Utils.unmarshal(response, new TypeReference<LedgerInfoResponse>() {}));
                } else {
