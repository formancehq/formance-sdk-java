...
public class GetLedgerInfo {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetLedgerInfoRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLedgerInfoRequest request) throws Exception {
        ...
        @Override
        public GetLedgerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    LedgerInfoResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLedgerInfoResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
