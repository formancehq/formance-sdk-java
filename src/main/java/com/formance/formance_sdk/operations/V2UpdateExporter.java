...
public class V2UpdateExporter {
    
    /**
     * V2_UPDATE_EXPORTER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_UPDATE_EXPORTER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2UpdateExporterRequest, V2UpdateExporterResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2UpdateExporterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2UpdateExporterRequest.class, new TypeReference<V2UpdateExporterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2UpdateExporterRequest request) {
        ...
        @Override
        public V2UpdateExporterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2UpdateExporterResponse.Builder resBuilder =
            ...
            V2UpdateExporterResponse res = resBuilder.build();
