...
public class V2CreateWorkflow {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(Optional<? extends V2WorkflowConfig> request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<Optional<? extends V2WorkflowConfig>>() {
                    });
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V2WorkflowConfig> request) throws Exception {
        ...
        @Override
        public V2CreateWorkflowResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CreateWorkflowResponse.Builder resBuilder =
            ...
            V2CreateWorkflowResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2CreateWorkflowResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2CreateWorkflowResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
