...
public class AddMetadataOnTransaction {
    
    /**
     * ADD_METADATA_ON_TRANSACTION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] ADD_METADATA_ON_TRANSACTION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        ADD_METADATA_ON_TRANSACTION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<AddMetadataOnTransactionRequest, AddMetadataOnTransactionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddMetadataOnTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMetadataOnTransactionRequest.class, new TypeReference<AddMetadataOnTransactionRequest>() {});
        ...
        public AddMetadataOnTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AddMetadataOnTransactionResponse.Builder resBuilder =
