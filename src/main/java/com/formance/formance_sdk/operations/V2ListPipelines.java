...
public class V2ListPipelines {
    
    /**
     * V2_LIST_PIPELINES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_PIPELINES_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2ListPipelinesRequest, V2ListPipelinesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2ListPipelinesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListPipelinesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListPipelinesRequest request) {
        ...
        @Override
        public V2ListPipelinesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2ListPipelinesResponse.Builder resBuilder =
            ...
            V2ListPipelinesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2PipelinesCursorResponse(Utils.unmarshal(response, new TypeReference<V2PipelinesCursorResponse>() {}));
                } else {
