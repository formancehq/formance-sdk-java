...
import com.formance.formance_sdk.models.operations.V2ListPipelinesResponseBody;
        ...
        public V2ListPipelinesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<V2ListPipelinesResponseBody>() {}));
                } else {
