...
public class UpdatePoolQuery {
    ...
    /**
     * UPDATE_POOL_QUERY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UPDATE_POOL_QUERY_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePoolQueryRequest, UpdatePoolQueryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdatePoolQueryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePoolQueryRequest.class, new TypeReference<UpdatePoolQueryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePoolQueryRequest request) {
        ...
        @Override
        public UpdatePoolQueryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePoolQueryResponse.Builder resBuilder =
            ...
            UpdatePoolQueryResponse res = resBuilder.build();
