...
public class V3RetryPaymentInitiation {
    
    /**
     * V3_RETRY_PAYMENT_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_RETRY_PAYMENT_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_RETRY_PAYMENT_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3RetryPaymentInitiationRequest, V3RetryPaymentInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3RetryPaymentInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3RetryPaymentInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3RetryPaymentInitiationRequest request) {
        ...
        @Override
        public V3RetryPaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3RetryPaymentInitiationResponse.Builder resBuilder =
            ...
            V3RetryPaymentInitiationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3RetryPaymentInitiationResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3RetryPaymentInitiationResponse>() {}));
                } else {
