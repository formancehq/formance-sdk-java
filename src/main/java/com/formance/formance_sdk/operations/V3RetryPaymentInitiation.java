...
public class V3RetryPaymentInitiation {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3RetryPaymentInitiationRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3RetryPaymentInitiationRequest request) throws Exception {
        ...
        @Override
        public V3RetryPaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3RetryPaymentInitiationResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3RetryPaymentInitiationResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
