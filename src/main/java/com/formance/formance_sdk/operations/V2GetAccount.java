...
public class V2GetAccount {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetAccountRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetAccountRequest request) throws Exception {
        ...
        @Override
        public V2GetAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2AccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2AccountResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
