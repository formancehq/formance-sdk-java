...
public class ListPools {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListPoolsRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPoolsRequest request) throws Exception {
        ...
        @Override
        public ListPoolsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PoolsCursor out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPoolsCursor(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
