...
public class ListPools {
    ...
    /**
     * LIST_POOLS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_POOLS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public ListPoolsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPoolsCursor(Utils.unmarshal(response, new TypeReference<PoolsCursor>() {}));
                } else {
