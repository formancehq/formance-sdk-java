...
import com.formance.formance_sdk.models.ledger.AccountsCursorResponse;
import com.formance.formance_sdk.models.ledger.ErrorResponse;
...
public class ListAccountsLedger {
    
    /**
     * LIST_ACCOUNTS_LEDGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_ACCOUNTS_LEDGER_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        LIST_ACCOUNTS_LEDGER_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountsLedgerRequest, ListAccountsLedgerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListAccountsLedgerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountsLedgerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountsLedgerRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "200", "404")) {
        ...
        @Override
        public ListAccountsLedgerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountsLedgerResponse.Builder resBuilder =
            ...
            ListAccountsLedgerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountsCursorResponse(Utils.unmarshal(response, new TypeReference<AccountsCursorResponse>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withErrorResponse(Utils.unmarshal(response, new TypeReference<ErrorResponse>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
