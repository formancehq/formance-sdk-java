...
public class GetRule {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRuleRequest, GetRuleResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRuleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRuleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRuleRequest request) {
        ...
        @Override
        public GetRuleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRuleResponse.Builder resBuilder =
                    GetRuleResponse
                            .builder()
            ...
            GetRuleResponse res = resBuilder.build();
