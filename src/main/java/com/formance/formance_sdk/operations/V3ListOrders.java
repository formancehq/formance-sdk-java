...
public class V3ListOrders {
    
    /**
     * V3_LIST_ORDERS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_ORDERS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListOrdersRequest, V3ListOrdersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListOrdersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListOrdersRequest.class, new TypeReference<V3ListOrdersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListOrdersRequest request) {
        ...
        @Override
        public V3ListOrdersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListOrdersResponse.Builder resBuilder =
            ...
            V3ListOrdersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3OrdersCursorResponse(Utils.unmarshal(response, new TypeReference<V3OrdersCursorResponse>() {}));
                } else {
