...
import com.formance.formance_sdk.models.orchestration.ListRunsResponse;
...
public class ListInstances {
    ...
    /**
     * LIST_INSTANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_INSTANCES_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ListInstancesRequest, ListInstancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListInstancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListInstancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListInstancesRequest request) {
        ...
        @Override
        public ListInstancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListInstancesResponse.Builder resBuilder =
            ...
            ListInstancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListRunsResponse(Utils.unmarshal(response, new TypeReference<ListRunsResponse>() {}));
                } else {
