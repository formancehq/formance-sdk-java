...
public class V3ListConnectorScheduleInstances {
    
    /**
     * V3_LIST_CONNECTOR_SCHEDULE_INSTANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_CONNECTOR_SCHEDULE_INSTANCES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_LIST_CONNECTOR_SCHEDULE_INSTANCES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListConnectorScheduleInstancesRequest, V3ListConnectorScheduleInstancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListConnectorScheduleInstancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListConnectorScheduleInstancesRequest.class);
        ...
        public V3ListConnectorScheduleInstancesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            V3ListConnectorScheduleInstancesResponse.Builder resBuilder =
            ...
            V3ListConnectorScheduleInstancesResponse res = resBuilder.build();
