...
public class ResetConnectorV1 {
    
    /**
     * RESET_CONNECTOR_V1_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] RESET_CONNECTOR_V1_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ResetConnectorV1Request, ResetConnectorV1Response> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ResetConnectorV1Request request) throws Exception {
            HttpRequest req = buildRequest(request, ResetConnectorV1Request.class);
        ...
        public ResetConnectorV1Response handleResponse(HttpResponse<InputStream> response) {
            ...
            ResetConnectorV1Response.Builder resBuilder =
            ...
            ResetConnectorV1Response res = resBuilder.build();
