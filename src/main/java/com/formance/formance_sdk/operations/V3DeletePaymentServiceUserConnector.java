...
public class V3DeletePaymentServiceUserConnector {
    
    /**
     * V3_DELETE_PAYMENT_SERVICE_USER_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_DELETE_PAYMENT_SERVICE_USER_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_DELETE_PAYMENT_SERVICE_USER_CONNECTOR_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3DeletePaymentServiceUserConnectorRequest, V3DeletePaymentServiceUserConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3DeletePaymentServiceUserConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DeletePaymentServiceUserConnectorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DeletePaymentServiceUserConnectorRequest request) {
        ...
        @Override
        public V3DeletePaymentServiceUserConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DeletePaymentServiceUserConnectorResponse.Builder resBuilder =
            ...
            V3DeletePaymentServiceUserConnectorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PaymentServiceUserDeleteConnectorResponse(Utils.unmarshal(response, new TypeReference<V3PaymentServiceUserDeleteConnectorResponse>() {}));
                } else {
