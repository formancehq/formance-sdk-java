...
import com.formance.formance_sdk.models.payments.ConnectorsResponse;
...
public class ListAllConnectors {
    ...
    /**
     * LIST_ALL_CONNECTORS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_ALL_CONNECTORS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListAllConnectorsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public ListAllConnectorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAllConnectorsResponse.Builder resBuilder =
            ...
            ListAllConnectorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectorsResponse(Utils.unmarshal(response, new TypeReference<ConnectorsResponse>() {}));
                } else {
