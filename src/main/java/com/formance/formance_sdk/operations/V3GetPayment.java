...
public class V3GetPayment {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetPaymentRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPaymentRequest request) throws Exception {
        ...
        @Override
        public V3GetPaymentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetPaymentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetPaymentResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
