...
public class ListTriggersOccurrences {
    
    /**
     * LIST_TRIGGERS_OCCURRENCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_TRIGGERS_OCCURRENCES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        LIST_TRIGGERS_OCCURRENCES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTriggersOccurrencesRequest, ListTriggersOccurrencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTriggersOccurrencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTriggersOccurrencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTriggersOccurrencesRequest request) {
        ...
        @Override
        public ListTriggersOccurrencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTriggersOccurrencesResponse.Builder resBuilder =
            ...
            ListTriggersOccurrencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTriggersOccurrencesResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.ListTriggersOccurrencesResponse>() {}));
                } else {
