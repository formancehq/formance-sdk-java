...
public class V3AddBankAccountToPaymentServiceUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3AddBankAccountToPaymentServiceUserRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3AddBankAccountToPaymentServiceUserRequest request) throws Exception {
        ...
        @Override
        public V3AddBankAccountToPaymentServiceUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
