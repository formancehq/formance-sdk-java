...
public class UnsnoozeAlert {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/alerts/{alertID}/unsnooze",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<UnsnoozeAlertRequest, UnsnoozeAlertResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UnsnoozeAlertRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnsnoozeAlertRequest.class, new TypeReference<UnsnoozeAlertRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnsnoozeAlertRequest request) {
        ...
        @Override
        public UnsnoozeAlertResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnsnoozeAlertResponse.Builder resBuilder =
            ...
            UnsnoozeAlertResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAlertResponse(Utils.unmarshal(response, new TypeReference<AlertResponse>() {}));
                } else {
