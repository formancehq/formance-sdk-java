...
public class PaymentsgetServerInfo {
    ...
    public static class Sync extends Base
        ...
        @Override
        public PaymentsgetServerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentsServerInfo out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentsServerInfo(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
