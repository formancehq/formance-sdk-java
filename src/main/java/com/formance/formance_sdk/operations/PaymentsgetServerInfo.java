...
public class PaymentsgetServerInfo {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<PaymentsgetServerInfoResponse> {
        ...
        @Override
        public PaymentsgetServerInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PaymentsgetServerInfoResponse.Builder resBuilder =
            ...
            PaymentsgetServerInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentsServerInfo(Utils.unmarshal(response, new TypeReference<PaymentsServerInfo>() {}));
                } else {
