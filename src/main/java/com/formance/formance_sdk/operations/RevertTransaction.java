...
import com.formance.formance_sdk.models.ledger.TransactionResponse;
...
public class RevertTransaction {
    ...
    /**
     * REVERT_TRANSACTION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] REVERT_TRANSACTION_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<RevertTransactionRequest, RevertTransactionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RevertTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevertTransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevertTransactionRequest request) {
        ...
        @Override
        public RevertTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevertTransactionResponse.Builder resBuilder =
            ...
            RevertTransactionResponse res = resBuilder.build();
