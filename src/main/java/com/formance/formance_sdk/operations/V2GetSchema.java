...
public class V2GetSchema {
    
    /**
     * V2_GET_SCHEMA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_SCHEMA_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2GetSchemaRequest, V2GetSchemaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2GetSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2GetSchemaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetSchemaRequest request) {
        ...
        @Override
        public V2GetSchemaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetSchemaResponse.Builder resBuilder =
                    V2GetSchemaResponse
                            .builder()
            ...
            V2GetSchemaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2SchemaResponse(Utils.unmarshal(response, new TypeReference<V2SchemaResponse>() {}));
                } else {
