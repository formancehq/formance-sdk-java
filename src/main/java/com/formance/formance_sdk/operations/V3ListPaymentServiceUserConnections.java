...
public class V3ListPaymentServiceUserConnections {
    
    /**
     * V3_LIST_PAYMENT_SERVICE_USER_CONNECTIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_PAYMENT_SERVICE_USER_CONNECTIONS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_LIST_PAYMENT_SERVICE_USER_CONNECTIONS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListPaymentServiceUserConnectionsRequest, V3ListPaymentServiceUserConnectionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListPaymentServiceUserConnectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListPaymentServiceUserConnectionsRequest.class, new TypeReference<V3ListPaymentServiceUserConnectionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentServiceUserConnectionsRequest request) {
        ...
        @Override
        public V3ListPaymentServiceUserConnectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListPaymentServiceUserConnectionsResponse.Builder resBuilder =
            ...
            V3ListPaymentServiceUserConnectionsResponse res = resBuilder.build();
