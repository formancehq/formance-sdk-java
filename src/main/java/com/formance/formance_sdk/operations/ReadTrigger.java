...
public class ReadTrigger {
    ...
    /**
     * READ_TRIGGER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] READ_TRIGGER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ReadTriggerRequest, ReadTriggerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReadTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReadTriggerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadTriggerRequest request) {
        ...
        @Override
        public ReadTriggerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReadTriggerResponse.Builder resBuilder =
                    ReadTriggerResponse
                            .builder()
            ...
            ReadTriggerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReadTriggerResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.orchestration.ReadTriggerResponse>() {}));
                } else {
