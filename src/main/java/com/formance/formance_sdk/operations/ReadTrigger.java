...
public class ReadTrigger {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ReadTriggerRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadTriggerRequest request) throws Exception {
        ...
        @Override
        public ReadTriggerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.ReadTriggerResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReadTriggerResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
