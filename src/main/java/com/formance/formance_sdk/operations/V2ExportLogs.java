...
public class V2ExportLogs {
    ...
    /**
     * V2_EXPORT_LOGS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_EXPORT_LOGS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2ExportLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ExportLogsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ExportLogsRequest request) {
        ...
        @Override
        public V2ExportLogsResponse handleResponse(HttpResponse<InputStream> response) {
