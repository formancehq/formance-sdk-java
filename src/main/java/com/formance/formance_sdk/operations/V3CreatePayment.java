...
public class V3CreatePayment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V3CreatePaymentRequest> request) {
        ...
        @Override
        public V3CreatePaymentResponse handleResponse(HttpResponse<InputStream> response) {
