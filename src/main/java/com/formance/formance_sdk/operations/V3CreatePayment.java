...
public class V3CreatePayment {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(Optional<? extends V3CreatePaymentRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends V3CreatePaymentRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V3CreatePaymentRequest> request) throws Exception {
        ...
        @Override
        public V3CreatePaymentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3CreatePaymentResponse.Builder resBuilder =
            ...
            V3CreatePaymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3CreatePaymentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3CreatePaymentResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
