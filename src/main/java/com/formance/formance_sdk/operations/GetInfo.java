...
import com.formance.formance_sdk.models.ledger.ConfigInfoResponse;
...
public class GetInfo {
    ...
    /**
     * GET_INFO_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_INFO_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetInfoResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConfigInfoResponse(Utils.unmarshal(response, new TypeReference<ConfigInfoResponse>() {}));
                } else {
