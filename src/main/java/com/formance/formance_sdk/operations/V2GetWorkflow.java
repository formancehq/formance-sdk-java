...
public class V2GetWorkflow {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetWorkflowRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetWorkflowRequest request) throws Exception {
        ...
        @Override
        public V2GetWorkflowResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2GetWorkflowResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2GetWorkflowResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
