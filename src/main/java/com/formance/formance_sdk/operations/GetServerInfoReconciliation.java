...
public class GetServerInfoReconciliation {
    
    /**
     * GET_SERVER_INFO_RECONCILIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_SERVER_INFO_RECONCILIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_SERVER_INFO_RECONCILIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetServerInfoReconciliationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        @Override
        public GetServerInfoReconciliationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetServerInfoReconciliationResponse.Builder resBuilder =
            ...
            GetServerInfoReconciliationResponse res = resBuilder.build();
