...
public class GetEvaluation {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/evaluations/{evaluationID}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEvaluationRequest, GetEvaluationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetEvaluationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEvaluationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEvaluationRequest request) {
        ...
        @Override
        public GetEvaluationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetEvaluationResponse.Builder resBuilder =
            ...
            GetEvaluationResponse res = resBuilder.build();
