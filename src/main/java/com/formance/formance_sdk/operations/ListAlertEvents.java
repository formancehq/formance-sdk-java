...
public class ListAlertEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAlertEventsRequest, ListAlertEventsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAlertEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAlertEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAlertEventsRequest request) {
        ...
        @Override
        public ListAlertEventsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAlertEventsResponse.Builder resBuilder =
            ...
            ListAlertEventsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAlertEventsCursorResponse(Utils.unmarshal(response, new TypeReference<AlertEventsCursorResponse>() {}));
                } else {
