...
public class V2DeleteAccountMetadata {
    ...
    /**
     * V2_DELETE_ACCOUNT_METADATA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_DELETE_ACCOUNT_METADATA_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_DELETE_ACCOUNT_METADATA_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        public V2DeleteAccountMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            V2DeleteAccountMetadataResponse.Builder resBuilder =
