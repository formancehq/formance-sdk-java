...
public class V2DeletePipeline {
    
    /**
     * V2_DELETE_PIPELINE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_DELETE_PIPELINE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2DeletePipelineRequest, V2DeletePipelineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2DeletePipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2DeletePipelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2DeletePipelineRequest request) {
        ...
        @Override
        public V2DeletePipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2DeletePipelineResponse.Builder resBuilder =
            ...
            V2DeletePipelineResponse res = resBuilder.build();
