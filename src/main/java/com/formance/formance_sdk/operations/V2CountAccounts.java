...
public class V2CountAccounts {
    ...
    /**
     * V2_COUNT_ACCOUNTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_COUNT_ACCOUNTS_SERVERS = {
        "http://localhost:8080/",
    };
