...
public class ReplayDelivery {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReplayDeliveryRequest, ReplayDeliveryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ReplayDeliveryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReplayDeliveryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReplayDeliveryRequest request) {
        ...
        @Override
        public ReplayDeliveryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReplayDeliveryResponse.Builder resBuilder =
            ...
            ReplayDeliveryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeliveryResponse(Utils.unmarshal(response, new TypeReference<DeliveryResponse>() {}));
                } else {
