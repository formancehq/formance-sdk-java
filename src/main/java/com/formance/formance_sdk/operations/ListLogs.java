...
import com.formance.formance_sdk.models.ledger.LogsCursorResponse;
...
public class ListLogs {
    ...
    /**
     * LIST_LOGS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_LOGS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLogsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLogsRequest request) {
        ...
        @Override
        public ListLogsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLogsCursorResponse(Utils.unmarshal(response, new TypeReference<LogsCursorResponse>() {}));
                } else {
