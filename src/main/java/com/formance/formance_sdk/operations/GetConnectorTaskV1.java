...
public class GetConnectorTaskV1 {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetConnectorTaskV1Request request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectorTaskV1Request request) throws Exception {
        ...
        @Override
        public GetConnectorTaskV1Response handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TaskResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
