...
public class ListPolicies {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ListPoliciesRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPoliciesRequest request) throws Exception {
        ...
        @Override
        public ListPoliciesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPoliciesResponse.Builder resBuilder =
            ...
            ListPoliciesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PoliciesCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPoliciesCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
