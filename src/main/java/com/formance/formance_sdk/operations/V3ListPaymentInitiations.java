...
public class V3ListPaymentInitiations {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3ListPaymentInitiationsRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentInitiationsRequest request) throws Exception {
        ...
        @Override
        public V3ListPaymentInitiationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListPaymentInitiationsResponse.Builder resBuilder =
            ...
            V3ListPaymentInitiationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3PaymentInitiationsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3PaymentInitiationsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
