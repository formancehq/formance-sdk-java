...
public class V3ListPaymentInitiations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListPaymentInitiationsRequest request) {
        ...
        @Override
        public V3ListPaymentInitiationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PaymentInitiationsCursorResponse(Utils.unmarshal(response, new TypeReference<V3PaymentInitiationsCursorResponse>() {}));
                } else {
