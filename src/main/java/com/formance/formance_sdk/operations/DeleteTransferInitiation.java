...
public class DeleteTransferInitiation {
    
    /**
     * DELETE_TRANSFER_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DELETE_TRANSFER_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        DELETE_TRANSFER_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteTransferInitiationRequest, DeleteTransferInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteTransferInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteTransferInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteTransferInitiationRequest request) {
        ...
        @Override
        public DeleteTransferInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteTransferInitiationResponse.Builder resBuilder =
            ...
            DeleteTransferInitiationResponse res = resBuilder.build();
