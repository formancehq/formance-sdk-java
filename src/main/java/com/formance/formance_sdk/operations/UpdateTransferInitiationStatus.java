...
public class UpdateTransferInitiationStatus {
    
    /**
     * UPDATE_TRANSFER_INITIATION_STATUS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UPDATE_TRANSFER_INITIATION_STATUS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        UPDATE_TRANSFER_INITIATION_STATUS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTransferInitiationStatusRequest, UpdateTransferInitiationStatusResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateTransferInitiationStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTransferInitiationStatusRequest.class, new TypeReference<UpdateTransferInitiationStatusRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTransferInitiationStatusRequest request) {
        ...
        @Override
        public UpdateTransferInitiationStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTransferInitiationStatusResponse.Builder resBuilder =
            ...
            UpdateTransferInitiationStatusResponse res = resBuilder.build();
