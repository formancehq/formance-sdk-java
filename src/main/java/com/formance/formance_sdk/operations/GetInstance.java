...
public class GetInstance {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetInstanceRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInstanceRequest request) throws Exception {
        ...
        @Override
        public GetInstanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetWorkflowInstanceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkflowInstanceResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
