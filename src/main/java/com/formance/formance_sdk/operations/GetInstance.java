...
public class GetInstance {
    ...
    /**
     * GET_INSTANCE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_INSTANCE_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInstanceRequest, GetInstanceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetInstanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInstanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInstanceRequest request) {
        ...
        @Override
        public GetInstanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInstanceResponse.Builder resBuilder =
                    GetInstanceResponse
                            .builder()
            ...
            GetInstanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkflowInstanceResponse(Utils.unmarshal(response, new TypeReference<GetWorkflowInstanceResponse>() {}));
                } else {
