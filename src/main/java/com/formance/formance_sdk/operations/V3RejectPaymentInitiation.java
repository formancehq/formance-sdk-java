...
public class V3RejectPaymentInitiation {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3RejectPaymentInitiationRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3RejectPaymentInitiationRequest request) throws Exception {
        ...
        @Override
        public V3RejectPaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
