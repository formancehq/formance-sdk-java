...
public class V3RejectPaymentInitiation {
    
    /**
     * V3_REJECT_PAYMENT_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_REJECT_PAYMENT_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_REJECT_PAYMENT_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3RejectPaymentInitiationRequest, V3RejectPaymentInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3RejectPaymentInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3RejectPaymentInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3RejectPaymentInitiationRequest request) {
        ...
        @Override
        public V3RejectPaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3RejectPaymentInitiationResponse.Builder resBuilder =
            ...
            V3RejectPaymentInitiationResponse res = resBuilder.build();
