...
public class UpdateMapping {
    ...
    /**
     * UPDATE_MAPPING_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UPDATE_MAPPING_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMappingRequest, UpdateMappingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMappingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMappingRequest.class, new TypeReference<UpdateMappingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMappingRequest request) {
        ...
        @Override
        public UpdateMappingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMappingResponse.Builder resBuilder =
            ...
            UpdateMappingResponse res = resBuilder.build();
