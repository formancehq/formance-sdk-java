...
public class V3GetPaymentServiceUserLinkAttemptFromConnectorID {
    
    /**
     * V3_GET_PAYMENT_SERVICE_USER_LINK_ATTEMPT_FROM_CONNECTOR_ID_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_PAYMENT_SERVICE_USER_LINK_ATTEMPT_FROM_CONNECTOR_ID_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_PAYMENT_SERVICE_USER_LINK_ATTEMPT_FROM_CONNECTOR_ID_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetPaymentServiceUserLinkAttemptFromConnectorIDRequest, V3GetPaymentServiceUserLinkAttemptFromConnectorIDResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetPaymentServiceUserLinkAttemptFromConnectorIDRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetPaymentServiceUserLinkAttemptFromConnectorIDRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPaymentServiceUserLinkAttemptFromConnectorIDRequest request) {
        ...
        @Override
        public V3GetPaymentServiceUserLinkAttemptFromConnectorIDResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetPaymentServiceUserLinkAttemptFromConnectorIDResponse.Builder resBuilder =
            ...
            V3GetPaymentServiceUserLinkAttemptFromConnectorIDResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3PaymentServiceUserLinkAttempt(Utils.unmarshal(response, new TypeReference<V3PaymentServiceUserLinkAttempt>() {}));
                } else {
