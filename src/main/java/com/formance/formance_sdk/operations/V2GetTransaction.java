...
public class V2GetTransaction {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetTransactionRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetTransactionRequest request) throws Exception {
        ...
        @Override
        public V2GetTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V2GetTransactionResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2GetTransactionResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
