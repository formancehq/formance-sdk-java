...
public class GetAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountRequest, GetAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountRequest request) {
        ...
        @Override
        public GetAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountResponse.Builder resBuilder =
                    GetAccountResponse
                            .builder()
            ...
            GetAccountResponse res = resBuilder.build();
