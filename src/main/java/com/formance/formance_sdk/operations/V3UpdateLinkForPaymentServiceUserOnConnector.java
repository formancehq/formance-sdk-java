...
public class V3UpdateLinkForPaymentServiceUserOnConnector {
    ...
    /**
     * V3_UPDATE_LINK_FOR_PAYMENT_SERVICE_USER_ON_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_UPDATE_LINK_FOR_PAYMENT_SERVICE_USER_ON_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_UPDATE_LINK_FOR_PAYMENT_SERVICE_USER_ON_CONNECTOR_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        public HttpResponse<InputStream> doRequest(V3UpdateLinkForPaymentServiceUserOnConnectorRequest request) {
            ...
            try {
                ...
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "201")) {
