...
public class GetInstanceStageHistory {
    ...
    /**
     * GET_INSTANCE_STAGE_HISTORY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_INSTANCE_STAGE_HISTORY_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_INSTANCE_STAGE_HISTORY_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetInstanceStageHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInstanceStageHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInstanceStageHistoryRequest request) {
        ...
        @Override
        public GetInstanceStageHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkflowInstanceHistoryStageResponse(Utils.unmarshal(response, new TypeReference<GetWorkflowInstanceHistoryStageResponse>() {}));
                } else {
