...
public class V3ListBankAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListBankAccountsRequest request) throws Exception {
        ...
        @Override
        public V3ListBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3BankAccountsCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3BankAccountsCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
