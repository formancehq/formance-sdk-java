...
public class V3ListBankAccounts {
    
    /**
     * V3_LIST_BANK_ACCOUNTS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_BANK_ACCOUNTS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_LIST_BANK_ACCOUNTS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListBankAccountsRequest, V3ListBankAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListBankAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListBankAccountsRequest.class, new TypeReference<V3ListBankAccountsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListBankAccountsRequest request) {
        ...
        @Override
        public V3ListBankAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListBankAccountsResponse.Builder resBuilder =
            ...
            V3ListBankAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3BankAccountsCursorResponse(Utils.unmarshal(response, new TypeReference<V3BankAccountsCursorResponse>() {}));
                } else {
