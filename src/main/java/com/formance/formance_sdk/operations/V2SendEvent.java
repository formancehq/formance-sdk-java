...
public class V2SendEvent {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2SendEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2SendEventRequest.class, new TypeReference<V2SendEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2SendEventRequest request) throws Exception {
        ...
        @Override
        public V2SendEventResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2SendEventResponse.Builder resBuilder =
                    V2SendEventResponse
                            .builder()
            ...
            V2SendEventResponse res = resBuilder.build();
