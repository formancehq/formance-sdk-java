...
import com.formance.formance_sdk.models.payments.V3ConnectorSchedulesCursorResponse;
...
public class V3ListConnectorSchedules {
    
    /**
     * V3_LIST_CONNECTOR_SCHEDULES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_LIST_CONNECTOR_SCHEDULES_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_LIST_CONNECTOR_SCHEDULES_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ListConnectorSchedulesRequest, V3ListConnectorSchedulesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ListConnectorSchedulesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ListConnectorSchedulesRequest.class, new TypeReference<V3ListConnectorSchedulesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListConnectorSchedulesRequest request) {
        ...
        @Override
        public V3ListConnectorSchedulesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ListConnectorSchedulesResponse.Builder resBuilder =
            ...
            V3ListConnectorSchedulesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ConnectorSchedulesCursorResponse(Utils.unmarshal(response, new TypeReference<V3ConnectorSchedulesCursorResponse>() {}));
                } else {
