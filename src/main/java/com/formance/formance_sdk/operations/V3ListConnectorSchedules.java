...
public class V3ListConnectorSchedules {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ListConnectorSchedulesRequest request) throws Exception {
        ...
        @Override
        public V3ListConnectorSchedulesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3ConnectorSchedulesCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ConnectorSchedulesCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
