...
public class V3InstallConnector {
    
    /**
     * V3_INSTALL_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_INSTALL_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_INSTALL_CONNECTOR_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3InstallConnectorRequest, V3InstallConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3InstallConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3InstallConnectorRequest.class, new TypeReference<V3InstallConnectorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3InstallConnectorRequest request) {
        ...
        @Override
        public V3InstallConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3InstallConnectorResponse.Builder resBuilder =
            ...
            V3InstallConnectorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3InstallConnectorResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3InstallConnectorResponse>() {}));
                } else {
