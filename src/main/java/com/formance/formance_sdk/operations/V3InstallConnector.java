...
public class V3InstallConnector {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3InstallConnectorRequest request) throws Exception {
        ...
        @Override
        public V3InstallConnectorResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3InstallConnectorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3InstallConnectorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
