...
public class V2GetInstanceStageHistory {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V2GetInstanceStageHistoryRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetInstanceStageHistoryRequest request) throws Exception {
        ...
        @Override
        public V2GetInstanceStageHistoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2GetWorkflowInstanceHistoryStageResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV2GetWorkflowInstanceHistoryStageResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
