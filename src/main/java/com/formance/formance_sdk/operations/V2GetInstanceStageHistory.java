...
public class V2GetInstanceStageHistory {
    
    /**
     * V2_GET_INSTANCE_STAGE_HISTORY_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_GET_INSTANCE_STAGE_HISTORY_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_GET_INSTANCE_STAGE_HISTORY_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V2GetInstanceStageHistoryRequest, V2GetInstanceStageHistoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2GetInstanceStageHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2GetInstanceStageHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2GetInstanceStageHistoryRequest request) {
        ...
        @Override
        public V2GetInstanceStageHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2GetInstanceStageHistoryResponse.Builder resBuilder =
            ...
            V2GetInstanceStageHistoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2GetWorkflowInstanceHistoryStageResponse(Utils.unmarshal(response, new TypeReference<V2GetWorkflowInstanceHistoryStageResponse>() {}));
                } else {
