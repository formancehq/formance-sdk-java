...
public class ConfirmHold {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ConfirmHoldRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConfirmHoldRequest.class, new TypeReference<ConfirmHoldRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConfirmHoldRequest request) throws Exception {
        ...
        @Override
        public ConfirmHoldResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConfirmHoldResponse.Builder resBuilder =
                    ConfirmHoldResponse
                            .builder()
            ...
            ConfirmHoldResponse res = resBuilder.build();
