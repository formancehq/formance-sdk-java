...
public class CreateAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<AccountRequest, CreateAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AccountRequest request) throws Exception {
        ...
        @Override
        public CreateAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountResponse.Builder resBuilder =
            ...
            CreateAccountResponse res = resBuilder.build();
