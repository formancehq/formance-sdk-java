...
public class GetServerInfo {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetServerInfoResponse> {
        ...
        @Override
        public GetServerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetServerInfoResponse.Builder resBuilder =
            ...
            GetServerInfoResponse res = resBuilder.build();
