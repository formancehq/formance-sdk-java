...
public class DeleteRule {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteRuleRequest, DeleteRuleResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteRuleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRuleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteRuleRequest request) {
        ...
        @Override
        public DeleteRuleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteRuleResponse.Builder resBuilder =
                    DeleteRuleResponse
                            .builder()
            ...
            DeleteRuleResponse res = resBuilder.build();
