...
public class ListTransferInitiations {
    
    /**
     * LIST_TRANSFER_INITIATIONS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] LIST_TRANSFER_INITIATIONS_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        LIST_TRANSFER_INITIATIONS_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTransferInitiationsRequest, ListTransferInitiationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListTransferInitiationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTransferInitiationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTransferInitiationsRequest request) {
        ...
        @Override
        public ListTransferInitiationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTransferInitiationsResponse.Builder resBuilder =
            ...
            ListTransferInitiationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransferInitiationsCursor(Utils.unmarshal(response, new TypeReference<TransferInitiationsCursor>() {}));
                } else {
