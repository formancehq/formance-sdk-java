...
import com.formance.formance_sdk.models.payments.TransferResponse;
...
public class ConnectorsTransfer {
    ...
    /**
     * CONNECTORS_TRANSFER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CONNECTORS_TRANSFER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorsTransferRequest request) {
        ...
        @Override
        public ConnectorsTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectorsTransferResponse.Builder resBuilder =
            ...
            ConnectorsTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransferResponse(Utils.unmarshal(response, new TypeReference<TransferResponse>() {}));
                } else {
