...
public class ConnectorsTransfer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectorsTransferRequest request) throws Exception {
        ...
        @Override
        public ConnectorsTransferResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TransferResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTransferResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
