...
import com.formance.formance_sdk.models.payments.PaymentResponse;
...
public class CreatePayment {
    ...
    /**
     * CREATE_PAYMENT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CREATE_PAYMENT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<PaymentRequest, CreatePaymentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PaymentRequest request) {
        ...
        @Override
        public CreatePaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentResponse.Builder resBuilder =
            ...
            CreatePaymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentResponse(Utils.unmarshal(response, new TypeReference<PaymentResponse>() {}));
                } else {
