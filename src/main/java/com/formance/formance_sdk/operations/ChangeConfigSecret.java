...
import com.formance.formance_sdk.models.webhooks.ConfigResponse;
...
public class ChangeConfigSecret {
    ...
    /**
     * CHANGE_CONFIG_SECRET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CHANGE_CONFIG_SECRET_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        CHANGE_CONFIG_SECRET_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ChangeConfigSecretRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ChangeConfigSecretRequest.class, new TypeReference<ChangeConfigSecretRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ChangeConfigSecretRequest request) {
        ...
        @Override
        public ChangeConfigSecretResponse handleResponse(HttpResponse<InputStream> response) {
