...
import com.formance.formance_sdk.models.webhooks.AttemptResponse;
...
public class TestConfig {
    ...
    /**
     * TEST_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] TEST_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<TestConfigRequest, TestConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TestConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TestConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TestConfigRequest request) {
        ...
        @Override
        public TestConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TestConfigResponse.Builder resBuilder =
                    TestConfigResponse
                            .builder()
            ...
            TestConfigResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttemptResponse(Utils.unmarshal(response, new TypeReference<AttemptResponse>() {}));
                } else {
