...
public class TestConfig {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(TestConfigRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TestConfigRequest request) throws Exception {
        ...
        @Override
        public TestConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AttemptResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAttemptResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
