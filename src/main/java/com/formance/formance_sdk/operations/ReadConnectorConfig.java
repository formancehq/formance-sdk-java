...
public class ReadConnectorConfig {
    
    /**
     * READ_CONNECTOR_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] READ_CONNECTOR_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        READ_CONNECTOR_CONFIG_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<ReadConnectorConfigRequest, ReadConnectorConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReadConnectorConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReadConnectorConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReadConnectorConfigRequest request) {
        ...
        @Override
        public ReadConnectorConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReadConnectorConfigResponse.Builder resBuilder =
            ...
            ReadConnectorConfigResponse res = resBuilder.build();
