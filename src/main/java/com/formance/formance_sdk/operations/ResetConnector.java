...
public class ResetConnector {
    ...
    /**
     * RESET_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] RESET_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<ResetConnectorRequest, ResetConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ResetConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResetConnectorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResetConnectorRequest request) {
        ...
        @Override
        public ResetConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResetConnectorResponse.Builder resBuilder =
            ...
            ResetConnectorResponse res = resBuilder.build();
