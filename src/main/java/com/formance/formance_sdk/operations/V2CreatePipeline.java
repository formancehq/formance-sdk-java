...
public class V2CreatePipeline {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2CreatePipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2CreatePipelineRequest.class, new TypeReference<V2CreatePipelineRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2CreatePipelineRequest request) throws Exception {
        ...
        @Override
        public V2CreatePipelineResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2CreatePipelineResponse.Builder resBuilder =
            ...
            V2CreatePipelineResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V2CreatePipelineResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
