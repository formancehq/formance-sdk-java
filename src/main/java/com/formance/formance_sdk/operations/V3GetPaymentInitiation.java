...
public class V3GetPaymentInitiation {
    
    /**
     * V3_GET_PAYMENT_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_PAYMENT_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_GET_PAYMENT_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetPaymentInitiationRequest, V3GetPaymentInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetPaymentInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetPaymentInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetPaymentInitiationRequest request) {
        ...
        @Override
        public V3GetPaymentInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetPaymentInitiationResponse.Builder resBuilder =
            ...
            V3GetPaymentInitiationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetPaymentInitiationResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetPaymentInitiationResponse>() {}));
                } else {
