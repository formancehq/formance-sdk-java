...
public class UninstallConnectorV1 {
    
    /**
     * UNINSTALL_CONNECTOR_V1_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] UNINSTALL_CONNECTOR_V1_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        UNINSTALL_CONNECTOR_V1_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<UninstallConnectorV1Request, UninstallConnectorV1Response> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UninstallConnectorV1Request request) throws Exception {
            HttpRequest req = buildRequest(request, UninstallConnectorV1Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UninstallConnectorV1Request request) {
        ...
        @Override
        public UninstallConnectorV1Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UninstallConnectorV1Response.Builder resBuilder =
            ...
            UninstallConnectorV1Response res = resBuilder.build();
