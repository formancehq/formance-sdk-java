...
public class V3GetAccount {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3GetAccountRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetAccountRequest request) throws Exception {
        ...
        @Override
        public V3GetAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3GetAccountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3GetAccountResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
