...
public class V3GetAccount {
    
    /**
     * V3_GET_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_ACCOUNT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetAccountRequest, V3GetAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetAccountRequest request) {
        ...
        @Override
        public V3GetAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetAccountResponse.Builder resBuilder =
            ...
            V3GetAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetAccountResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetAccountResponse>() {}));
                } else {
