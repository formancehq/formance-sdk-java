...
public class GetTransferInitiation {
    
    /**
     * GET_TRANSFER_INITIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_TRANSFER_INITIATION_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        GET_TRANSFER_INITIATION_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransferInitiationRequest, GetTransferInitiationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetTransferInitiationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransferInitiationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransferInitiationRequest request) {
        ...
        @Override
        public GetTransferInitiationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransferInitiationResponse.Builder resBuilder =
            ...
            GetTransferInitiationResponse res = resBuilder.build();
