...
public class RemoveAccountFromPool {
    
    /**
     * REMOVE_ACCOUNT_FROM_POOL_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] REMOVE_ACCOUNT_FROM_POOL_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        REMOVE_ACCOUNT_FROM_POOL_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountFromPoolRequest, RemoveAccountFromPoolResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveAccountFromPoolRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountFromPoolRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountFromPoolRequest request) {
        ...
        @Override
        public RemoveAccountFromPoolResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountFromPoolResponse.Builder resBuilder =
            ...
            RemoveAccountFromPoolResponse res = resBuilder.build();
