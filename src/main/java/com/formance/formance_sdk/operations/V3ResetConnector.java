...
public class V3ResetConnector {
    
    /**
     * V3_RESET_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_RESET_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ResetConnectorRequest, V3ResetConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3ResetConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ResetConnectorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ResetConnectorRequest request) {
        ...
        @Override
        public V3ResetConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ResetConnectorResponse.Builder resBuilder =
            ...
            V3ResetConnectorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ResetConnectorResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3ResetConnectorResponse>() {}));
                } else {
