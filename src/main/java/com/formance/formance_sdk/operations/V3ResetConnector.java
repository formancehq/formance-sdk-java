...
public class V3ResetConnector {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(V3ResetConnectorRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ResetConnectorRequest request) throws Exception {
        ...
        @Override
        public V3ResetConnectorResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.formance.formance_sdk.models.shared.V3ResetConnectorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ResetConnectorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
