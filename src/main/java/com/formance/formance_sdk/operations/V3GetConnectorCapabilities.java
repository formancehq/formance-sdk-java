...
public class V3GetConnectorCapabilities {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/payments/v3/connectors/{connectorID}/capabilities",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetConnectorCapabilitiesRequest, V3GetConnectorCapabilitiesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(V3GetConnectorCapabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetConnectorCapabilitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetConnectorCapabilitiesRequest request) {
        ...
        @Override
        public V3GetConnectorCapabilitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetConnectorCapabilitiesResponse.Builder resBuilder =
            ...
            V3GetConnectorCapabilitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ConnectorCapabilityResponse(Utils.unmarshal(response, new TypeReference<V3ConnectorCapabilityResponse>() {}));
                } else {
