...
public class DeactivateConfig {
    
    /**
     * DEACTIVATE_CONFIG_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEACTIVATE_CONFIG_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<DeactivateConfigRequest, DeactivateConfigResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeactivateConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeactivateConfigRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeactivateConfigRequest request) {
        ...
        @Override
        public DeactivateConfigResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeactivateConfigResponse.Builder resBuilder =
            ...
            DeactivateConfigResponse res = resBuilder.build();
