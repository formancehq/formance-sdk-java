...
import com.formance.formance_sdk.models.payments.ConnectorResponse;
...
public class InstallConnector {
    
    /**
     * INSTALL_CONNECTOR_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] INSTALL_CONNECTOR_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<InstallConnectorRequest, InstallConnectorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(InstallConnectorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InstallConnectorRequest.class, new TypeReference<InstallConnectorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InstallConnectorRequest request) {
        ...
        @Override
        public InstallConnectorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            InstallConnectorResponse.Builder resBuilder =
            ...
            InstallConnectorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectorResponse(Utils.unmarshal(response, new TypeReference<ConnectorResponse>() {}));
                } else {
