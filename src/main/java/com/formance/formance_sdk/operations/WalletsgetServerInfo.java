...
public class WalletsgetServerInfo {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<WalletsgetServerInfoResponse> {
        ...
        @Override
        public WalletsgetServerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WalletsgetServerInfoResponse.Builder resBuilder =
            ...
            WalletsgetServerInfoResponse res = resBuilder.build();
