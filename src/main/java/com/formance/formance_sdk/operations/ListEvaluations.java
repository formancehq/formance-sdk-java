...
public class ListEvaluations {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    this.baseUrl,
                    "/api/reconciliation/evaluations");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEvaluationsRequest, ListEvaluationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListEvaluationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEvaluationsRequest.class, new TypeReference<ListEvaluationsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEvaluationsRequest request) {
        ...
        @Override
        public ListEvaluationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEvaluationsResponse.Builder resBuilder =
            ...
            ListEvaluationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEvaluationsCursorResponse(Utils.unmarshal(response, new TypeReference<EvaluationsCursorResponse>() {}));
                } else {
