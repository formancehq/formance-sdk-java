...
public class GetReconciliation {
    
    /**
     * GET_RECONCILIATION_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_RECONCILIATION_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetReconciliationRequest, GetReconciliationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetReconciliationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReconciliationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetReconciliationRequest request) {
        ...
        @Override
        public GetReconciliationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetReconciliationResponse.Builder resBuilder =
            ...
            GetReconciliationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReconciliationResponse(Utils.unmarshal(response, new TypeReference<ReconciliationResponse>() {}));
                } else {
