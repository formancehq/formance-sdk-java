...
public class V2UpdateLedgerMetadata {
    ...
    /**
     * V2_UPDATE_LEDGER_METADATA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_UPDATE_LEDGER_METADATA_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_UPDATE_LEDGER_METADATA_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2UpdateLedgerMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2UpdateLedgerMetadataRequest.class, new TypeReference<V2UpdateLedgerMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2UpdateLedgerMetadataRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "204", "5XX")) {
        ...
        @Override
        public V2UpdateLedgerMetadataResponse handleResponse(HttpResponse<InputStream> response) {
