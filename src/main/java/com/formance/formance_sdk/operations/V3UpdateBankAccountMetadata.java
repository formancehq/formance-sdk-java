...
public class V3UpdateBankAccountMetadata {
    
    /**
     * V3_UPDATE_BANK_ACCOUNT_METADATA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_UPDATE_BANK_ACCOUNT_METADATA_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_UPDATE_BANK_ACCOUNT_METADATA_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3UpdateBankAccountMetadataRequest, V3UpdateBankAccountMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3UpdateBankAccountMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3UpdateBankAccountMetadataRequest.class, new TypeReference<V3UpdateBankAccountMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3UpdateBankAccountMetadataRequest request) {
        ...
        @Override
        public V3UpdateBankAccountMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3UpdateBankAccountMetadataResponse.Builder resBuilder =
            ...
            V3UpdateBankAccountMetadataResponse res = resBuilder.build();
