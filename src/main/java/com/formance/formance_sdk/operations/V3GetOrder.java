...
public class V3GetOrder {
    
    /**
     * V3_GET_ORDER_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_GET_ORDER_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/payments/v3/orders/{orderID}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<V3GetOrderRequest, V3GetOrderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3GetOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetOrderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetOrderRequest request) {
        ...
        @Override
        public V3GetOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3GetOrderResponse.Builder resBuilder =
                    V3GetOrderResponse
                            .builder()
            ...
            V3GetOrderResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetOrderResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3GetOrderResponse>() {}));
                } else {
