...
public class GetHolds {
    ...
    /**
     * GET_HOLDS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_HOLDS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetHoldsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHoldsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHoldsRequest request) {
        ...
        @Override
        public GetHoldsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetHoldsResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.wallets.GetHoldsResponse>() {}));
                } else {
