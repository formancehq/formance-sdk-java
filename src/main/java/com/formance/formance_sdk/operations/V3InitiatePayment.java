...
public class V3InitiatePayment {
    ...
    /**
     * V3_INITIATE_PAYMENT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_INITIATE_PAYMENT_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V3InitiatePaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3InitiatePaymentRequest.class, new TypeReference<V3InitiatePaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3InitiatePaymentRequest request) {
        ...
        @Override
        public V3InitiatePaymentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3InitiatePaymentResponse(Utils.unmarshal(response, new TypeReference<com.formance.formance_sdk.models.payments.V3InitiatePaymentResponse>() {}));
                } else {
