...
public class V2AddMetadataToAccount {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2AddMetadataToAccountRequest request) throws Exception {
        ...
        @Override
        public V2AddMetadataToAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
