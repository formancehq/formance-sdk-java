...
public class V2AddMetadataToAccount {
    ...
    /**
     * V2_ADD_METADATA_TO_ACCOUNT_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_ADD_METADATA_TO_ACCOUNT_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V2_ADD_METADATA_TO_ACCOUNT_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2AddMetadataToAccountRequest request) {
        ...
        @Override
        public V2AddMetadataToAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2AddMetadataToAccountResponse.Builder resBuilder =
            ...
            V2AddMetadataToAccountResponse res = resBuilder.build();
