...
public class V3UpdatePaymentMetadata {
    
    /**
     * V3_UPDATE_PAYMENT_METADATA_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V3_UPDATE_PAYMENT_METADATA_SERVERS = {
        "http://localhost:8080/",
    };
        ...
        public Base(
            ...
            this.baseUrl = serverURL
                    ...
                    .orElse(Utils.templateUrl(
                        V3_UPDATE_PAYMENT_METADATA_SERVERS[0], 
                        Map.of()));
    ...
    public static class Sync extends Base
            implements RequestOperation<V3UpdatePaymentMetadataRequest, V3UpdatePaymentMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V3UpdatePaymentMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3UpdatePaymentMetadataRequest.class, new TypeReference<V3UpdatePaymentMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3UpdatePaymentMetadataRequest request) {
        ...
        @Override
        public V3UpdatePaymentMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3UpdatePaymentMetadataResponse.Builder resBuilder =
            ...
            V3UpdatePaymentMetadataResponse res = resBuilder.build();
