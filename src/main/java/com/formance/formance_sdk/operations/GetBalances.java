...
import com.formance.formance_sdk.models.ledger.BalancesCursorResponse;
...
public class GetBalances {
    ...
    /**
     * GET_BALANCES_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_BALANCES_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBalancesRequest, GetBalancesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBalancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBalancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBalancesRequest request) {
        ...
        @Override
        public GetBalancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBalancesResponse.Builder resBuilder =
                    GetBalancesResponse
                            .builder()
            ...
            GetBalancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBalancesCursorResponse(Utils.unmarshal(response, new TypeReference<BalancesCursorResponse>() {}));
                } else {
