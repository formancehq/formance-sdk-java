...
public class GetBalances {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetBalancesRequest request) throws Exception {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBalancesRequest request) throws Exception {
        ...
        @Override
        public GetBalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BalancesCursorResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBalancesCursorResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
