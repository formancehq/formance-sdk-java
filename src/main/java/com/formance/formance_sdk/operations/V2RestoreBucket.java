...
public class V2RestoreBucket {
    
    /**
     * V2_RESTORE_BUCKET_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_RESTORE_BUCKET_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<V2RestoreBucketRequest, V2RestoreBucketResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(V2RestoreBucketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2RestoreBucketRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2RestoreBucketRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (!Utils.statusCodeMatches(httpRes.statusCode(), "204", "404")) {
        ...
        @Override
        public V2RestoreBucketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V2RestoreBucketResponse.Builder resBuilder =
            ...
            V2RestoreBucketResponse res = resBuilder.build();
