...
import com.formance.formance_sdk.models.webhooks.ConfigsResponse;
...
public class GetManyConfigs {
    
    /**
     * GET_MANY_CONFIGS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GET_MANY_CONFIGS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
            implements RequestOperation<GetManyConfigsRequest, GetManyConfigsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<String> serverURL,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetManyConfigsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetManyConfigsRequest.class);
        ...
        public GetManyConfigsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetManyConfigsResponse.Builder resBuilder =
            ...
            GetManyConfigsResponse res = resBuilder.build();
