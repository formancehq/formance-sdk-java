...
public class V2ListLogs {
    ...
    /**
     * V2_LIST_LOGS_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] V2_LIST_LOGS_SERVERS = {
        "http://localhost:8080/",
    };
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V2ListLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V2ListLogsRequest.class, new TypeReference<V2ListLogsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V2ListLogsRequest request) {
        ...
        @Override
        public V2ListLogsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV2LogsCursorResponse(Utils.unmarshal(response, new TypeReference<V2LogsCursorResponse>() {}));
                } else {
