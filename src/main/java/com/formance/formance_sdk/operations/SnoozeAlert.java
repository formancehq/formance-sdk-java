...
public class SnoozeAlert {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/reconciliation/alerts/{alertID}/snooze",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<SnoozeAlertRequest, SnoozeAlertResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SnoozeAlertRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SnoozeAlertRequest.class, new TypeReference<SnoozeAlertRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SnoozeAlertRequest request) {
        ...
        @Override
        public SnoozeAlertResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SnoozeAlertResponse.Builder resBuilder =
                    SnoozeAlertResponse
                            .builder()
            ...
            SnoozeAlertResponse res = resBuilder.build();
