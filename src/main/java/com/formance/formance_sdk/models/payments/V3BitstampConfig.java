...
public class V3BitstampConfig implements V3ConnectorConfig {
    ...
    public V3BitstampConfig withApiKey(String apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }

    public V3BitstampConfig withApiSecret(String apiSecret) {
        Utils.checkNotNull(apiSecret, "apiSecret");
        this.apiSecret = apiSecret;
        return this;
    }

    public V3BitstampConfig withEndpoint(String endpoint) {
        Utils.checkNotNull(endpoint, "endpoint");
    ...
    public V3BitstampConfig withEndpoint(Optional<String> endpoint) {
        Utils.checkNotNull(endpoint, "endpoint");
        this.endpoint = endpoint;
        return this;
    }

    public V3BitstampConfig withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     */
    @Deprecated
    public V3BitstampConfig withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     */
    @Deprecated
    public V3BitstampConfig withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V3BitstampConfig withPollingPeriod(String pollingPeriod) {
        Utils.checkNotNull(pollingPeriod, "pollingPeriod");
    ...
    public V3BitstampConfig withPollingPeriod(Optional<String> pollingPeriod) {
        Utils.checkNotNull(pollingPeriod, "pollingPeriod");
        this.pollingPeriod = pollingPeriod;
        return this;
    }

    public V3BitstampConfig withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
    ...
    public V3BitstampConfig withProvider(Optional<String> provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3BitstampConfig other = (V3BitstampConfig) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3BitstampConfig.class,
                "apiKey", apiKey,
                "apiSecret", apiSecret,
                "endpoint", endpoint,
                "name", name,
