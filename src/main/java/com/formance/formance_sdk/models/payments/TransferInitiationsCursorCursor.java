 ...
 * 
 * <p>Paginated cursor wrapping the list of transfer initiations
 */
public class TransferInitiationsCursorCursor {
    ...
    public TransferInitiationsCursorCursor withData(List<TransferInitiation> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Cursor for the next page, absent on the last page
     */
    public TransferInitiationsCursorCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
     ...
     * Cursor for the previous page, absent on the first page
     */
    public TransferInitiationsCursorCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
