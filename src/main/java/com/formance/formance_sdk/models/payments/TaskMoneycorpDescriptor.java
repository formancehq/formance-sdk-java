...
public class TaskMoneycorpDescriptor {
    ...
    public TaskMoneycorpDescriptor withAccountID(Optional<String> accountID) {
        Utils.checkNotNull(accountID, "accountID");
        this.accountID = accountID;
        return this;
    }
    ...
    public TaskMoneycorpDescriptor withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }
    ...
    public TaskMoneycorpDescriptor withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
