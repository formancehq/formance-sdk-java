...
public class PoolsCursorCursorBase {
    ...
    public PoolsCursorCursorBase withData(List<Pool> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public PoolsCursorCursorBase withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public PoolsCursorCursorBase withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public PoolsCursorCursorBase withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public PoolsCursorCursorBase withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public PoolsCursorCursorBase withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public PoolsCursorCursorBase withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PoolsCursorCursorBase other = (PoolsCursorCursorBase) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PoolsCursorCursorBase.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public PoolsCursorCursorBase build() {

            return new PoolsCursorCursorBase(
                data, hasMore, next,
                pageSize, previous);
        }
