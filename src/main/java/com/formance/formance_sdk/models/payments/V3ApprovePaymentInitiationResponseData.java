 ...
 * 
 * <p>The task tracking the approval, which completes asynchronously
 */
public class V3ApprovePaymentInitiationResponseData {
    ...
    @JsonCreator
    public V3ApprovePaymentInitiationResponseData(
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3ApprovePaymentInitiationResponseData other = (V3ApprovePaymentInitiationResponseData) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3ApprovePaymentInitiationResponseData.class,
                "taskID", taskID);
    }
    ...
    public final static class Builder {
        ...
        public V3ApprovePaymentInitiationResponseData build() {

            return new V3ApprovePaymentInitiationResponseData(
                taskID);
        }
