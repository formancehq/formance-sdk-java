...
public class V3TinkConfig implements V3ConnectorConfig {
    ...
    public V3TinkConfig(
            ...
            String endpoint,
            String name) {
        this(clientID, clientSecret, endpoint,
    ...
    public V3TinkConfig withClientID(String clientID) {
        Utils.checkNotNull(clientID, "clientID");
        this.clientID = clientID;
        return this;
    }

    public V3TinkConfig withClientSecret(String clientSecret) {
        Utils.checkNotNull(clientSecret, "clientSecret");
        this.clientSecret = clientSecret;
        return this;
    }

    public V3TinkConfig withEndpoint(String endpoint) {
        Utils.checkNotNull(endpoint, "endpoint");
        this.endpoint = endpoint;
        return this;
    }

    public V3TinkConfig withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     */
    @Deprecated
    public V3TinkConfig withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     */
    @Deprecated
    public V3TinkConfig withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V3TinkConfig withPollingPeriod(String pollingPeriod) {
        Utils.checkNotNull(pollingPeriod, "pollingPeriod");
    ...
    public V3TinkConfig withPollingPeriod(Optional<String> pollingPeriod) {
        Utils.checkNotNull(pollingPeriod, "pollingPeriod");
        this.pollingPeriod = pollingPeriod;
        return this;
    }

    public V3TinkConfig withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
    ...
    public V3TinkConfig withProvider(Optional<String> provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3TinkConfig other = (V3TinkConfig) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3TinkConfig.class,
                "clientID", clientID,
