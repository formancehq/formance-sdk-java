...
public class WebhooksErrorResponse extends SDKBaseError {
    ...
    /**
    * Parse a response into an instance of WebhooksErrorResponse. If deserialization of the response body fails,
    * the resulting WebhooksErrorResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static WebhooksErrorResponse from(HttpResponse<InputStream> response) {
        try {
            byte[] bytes = Utils.extractByteArrayFromBody(response);
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new WebhooksErrorResponse(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new WebhooksErrorResponse(response.statusCode(), null, response, null, e);
        }
    }
    ...
    @Deprecated
    public Optional<WebhooksErrorsEnum> errorCode() {
    ...
    public static class Data {
        ...
        public Data withErrorCode(WebhooksErrorsEnum errorCode) {
            Utils.checkNotNull(errorCode, "errorCode");
            this.errorCode = errorCode;
            return this;
        }
