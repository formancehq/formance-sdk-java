...
public class GetAccountPaymentsResponse implements Response {
    /**
     * OK
     */
    ...
    @JsonCreator
    public GetAccountPaymentsResponse(
     ...
     * OK
     */
    public GetAccountPaymentsResponse withAccountResponse(AccountResponse accountResponse) {
        Utils.checkNotNull(accountResponse, "accountResponse");
     ...
     * OK
     */
    public GetAccountPaymentsResponse withAccountResponse(Optional<? extends AccountResponse> accountResponse) {
        Utils.checkNotNull(accountResponse, "accountResponse");
        this.accountResponse = accountResponse;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetAccountPaymentsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetAccountPaymentsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAccountPaymentsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAccountPaymentsResponse other = (GetAccountPaymentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAccountPaymentsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetAccountPaymentsResponse build() {

            return new GetAccountPaymentsResponse(
                accountResponse, contentType, statusCode,
                rawResponse);
        }
