...
public class V3ListPaymentInitiationRelatedPaymentsRequest {
    ...
    public V3ListPaymentInitiationRelatedPaymentsRequest withQuery(Map<String, Object> query) {
        Utils.checkNotNull(query, "query");
    ...
    public V3ListPaymentInitiationRelatedPaymentsRequest withQuery(Optional<? extends Map<String, Object>> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
