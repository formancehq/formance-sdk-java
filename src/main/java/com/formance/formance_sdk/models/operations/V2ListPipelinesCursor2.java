...
public class V2ListPipelinesCursor2 {
    ...
    public V2ListPipelinesCursor2 withData(List<V2Pipeline> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public V2ListPipelinesCursor2 withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public V2ListPipelinesCursor2 withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public V2ListPipelinesCursor2 withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public V2ListPipelinesCursor2 withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V2ListPipelinesCursor2 withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public V2ListPipelinesCursor2 withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2ListPipelinesCursor2 other = (V2ListPipelinesCursor2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2ListPipelinesCursor2.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public V2ListPipelinesCursor2 build() {

            return new V2ListPipelinesCursor2(
                data, hasMore, next,
                pageSize, previous);
        }
