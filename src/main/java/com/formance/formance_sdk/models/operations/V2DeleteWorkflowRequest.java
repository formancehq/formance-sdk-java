...
public class V2DeleteWorkflowRequest {
    ...
    @JsonCreator
    public V2DeleteWorkflowRequest(
            String flowId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2DeleteWorkflowRequest other = (V2DeleteWorkflowRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2DeleteWorkflowRequest.class,
                "flowId", flowId);
    }
    ...
    public final static class Builder {
        ...
        public V2DeleteWorkflowRequest build() {
            return new V2DeleteWorkflowRequest(
                flowId);
        }
    }
}
