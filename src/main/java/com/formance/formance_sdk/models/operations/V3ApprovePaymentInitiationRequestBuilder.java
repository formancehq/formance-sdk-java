...
public class V3ApprovePaymentInitiationRequestBuilder {
    ...
    public V3ApprovePaymentInitiationRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public V3ApprovePaymentInitiationRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
