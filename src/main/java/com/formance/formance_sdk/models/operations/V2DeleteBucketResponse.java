...
public class V2DeleteBucketResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public V2DeleteBucketResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public V2DeleteBucketResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public V2DeleteBucketResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Bucket not found
     */
    public V2DeleteBucketResponse withV2ErrorResponse(V2ErrorResponse v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
     ...
     * Bucket not found
     */
    public V2DeleteBucketResponse withV2ErrorResponse(Optional<? extends V2ErrorResponse> v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
        this.v2ErrorResponse = v2ErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2DeleteBucketResponse other = (V2DeleteBucketResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2DeleteBucketResponse.class,
    ...
    public final static class Builder {
        ...
        public V2DeleteBucketResponse build() {
