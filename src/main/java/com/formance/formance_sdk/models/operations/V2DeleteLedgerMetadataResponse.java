...
public class V2DeleteLedgerMetadataResponse implements com.formance.formance_sdk.utils.Response {
    ...
    public V2DeleteLedgerMetadataResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public V2DeleteLedgerMetadataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public V2DeleteLedgerMetadataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public V2DeleteLedgerMetadataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Error
     */
    public V2DeleteLedgerMetadataResponse withV2ErrorResponse(com.formance.formance_sdk.models.errors.V2ErrorResponse v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
     ...
     * Error
     */
    public V2DeleteLedgerMetadataResponse withV2ErrorResponse(Optional<? extends com.formance.formance_sdk.models.errors.V2ErrorResponse> v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
        this.v2ErrorResponse = v2ErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2DeleteLedgerMetadataResponse other = (V2DeleteLedgerMetadataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2DeleteLedgerMetadataResponse.class,
    ...
    public final static class Builder {
        ...
        public V2DeleteLedgerMetadataResponse build() {
