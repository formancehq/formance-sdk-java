...
public class UpdateBankAccountMetadataRequestBuilder {
    ...
    public UpdateBankAccountMetadataRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public UpdateBankAccountMetadataRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
