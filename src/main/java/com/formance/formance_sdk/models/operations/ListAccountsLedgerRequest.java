...
public class ListAccountsLedgerRequest {
    ...
    @JsonCreator
    public ListAccountsLedgerRequest(
     ...
     * Filter accounts by address pattern (regular expression placed between ^ and $).
     */
    public ListAccountsLedgerRequest withAddress(String address) {
        Utils.checkNotNull(address, "address");
     ...
     * Filter accounts by address pattern (regular expression placed between ^ and $).
     */
    public ListAccountsLedgerRequest withAddress(Optional<String> address) {
        Utils.checkNotNull(address, "address");
        this.address = address;
        return this;
    }
     ...
     * Pagination cursor, will return accounts after given address, in descending order.
     */
    public ListAccountsLedgerRequest withAfter(String after) {
        Utils.checkNotNull(after, "after");
     ...
     * Pagination cursor, will return accounts after given address, in descending order.
     */
    public ListAccountsLedgerRequest withAfter(Optional<String> after) {
        Utils.checkNotNull(after, "after");
        this.after = after;
        return this;
    }
     ...
     * Filter accounts by their balance (default operator is gte)
     */
    public ListAccountsLedgerRequest withBalance(long balance) {
        Utils.checkNotNull(balance, "balance");
     ...
     * Filter accounts by their balance (default operator is gte)
     */
    public ListAccountsLedgerRequest withBalance(Optional<Long> balance) {
        Utils.checkNotNull(balance, "balance");
        this.balance = balance;
        return this;
    }
     ...
     * No other parameters can be set when this parameter is set.
     */
    public ListAccountsLedgerRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * No other parameters can be set when this parameter is set.
     */
    public ListAccountsLedgerRequest withCursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * Name of the ledger.
     */
    public ListAccountsLedgerRequest withLedger(String ledger) {
        Utils.checkNotNull(ledger, "ledger");
        this.ledger = ledger;
        return this;
    }
     ...
     * below.
     */
    public ListAccountsLedgerRequest withMetadata(Map<String, Object> metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * below.
     */
    public ListAccountsLedgerRequest withMetadata(Optional<? extends Map<String, Object>> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * The maximum number of results to return per page.
     */
    public ListAccountsLedgerRequest withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The maximum number of results to return per page.
     */
    public ListAccountsLedgerRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     */
    @Deprecated
    public ListAccountsLedgerRequest withPaginationToken(String paginationToken) {
        Utils.checkNotNull(paginationToken, "paginationToken");
     ...
     */
    @Deprecated
    public ListAccountsLedgerRequest withPaginationToken(Optional<String> paginationToken) {
        Utils.checkNotNull(paginationToken, "paginationToken");
        this.paginationToken = paginationToken;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAccountsLedgerRequest other = (ListAccountsLedgerRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAccountsLedgerRequest.class,
                "address", address,
                "after", after,
                "balance", balance,
                "cursor", cursor,
    ...
    public final static class Builder {
        ...
        public ListAccountsLedgerRequest build() {

            return new ListAccountsLedgerRequest(
                address, after, balance,
                cursor, ledger, metadata,
                pageSize, paginationToken);
        }
