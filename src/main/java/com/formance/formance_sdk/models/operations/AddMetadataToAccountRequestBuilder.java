...
public class AddMetadataToAccountRequestBuilder {
    ...
    public AddMetadataToAccountRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public AddMetadataToAccountRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = serverURL;
        return this;
    }

    public AddMetadataToAccountResponse call() {
