...
public class ListPaymentsRequest {
     ...
     * 
     */
    public ListPaymentsRequest withCursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * 
     */
    public ListPaymentsRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * 
     */
    public ListPaymentsRequest withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
     ...
     * Fields used to sort payments (default is date:desc).
     */
    public ListPaymentsRequest withSort(List<String> sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * Fields used to sort payments (default is date:desc).
     */
    public ListPaymentsRequest withSort(Optional<? extends List<String>> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
