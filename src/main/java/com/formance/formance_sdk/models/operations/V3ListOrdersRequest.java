...
public class V3ListOrdersRequest {
    ...
    public V3ListOrdersRequest withRequestBody(Map<String, Object> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
    ...
    public V3ListOrdersRequest withRequestBody(Optional<? extends Map<String, Object>> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
     ...
     * <p>No other parameters can be set when this parameter is set.
     */
    public V3ListOrdersRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * <p>No other parameters can be set when this parameter is set.
     */
    public V3ListOrdersRequest withCursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * The number of items to return
     */
    public V3ListOrdersRequest withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of items to return
     */
    public V3ListOrdersRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3ListOrdersRequest other = (V3ListOrdersRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3ListOrdersRequest.class,
    ...
    public final static class Builder {
        ...
        public V3ListOrdersRequest build() {

            return new V3ListOrdersRequest(
                requestBody, cursor, pageSize);
        }
