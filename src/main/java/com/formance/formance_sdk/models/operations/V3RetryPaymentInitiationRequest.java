...
public class V3RetryPaymentInitiationRequest {
    ...
    @JsonCreator
    public V3RetryPaymentInitiationRequest(
     ...
     * The payment initiation ID
     */
    public V3RetryPaymentInitiationRequest withPaymentInitiationID(String paymentInitiationID) {
        Utils.checkNotNull(paymentInitiationID, "paymentInitiationID");
        this.paymentInitiationID = paymentInitiationID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3RetryPaymentInitiationRequest other = (V3RetryPaymentInitiationRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3RetryPaymentInitiationRequest.class,
    ...
    public final static class Builder {
        ...
        public V3RetryPaymentInitiationRequest build() {
            return new V3RetryPaymentInitiationRequest(
                paymentInitiationID);
        }
    }
}
