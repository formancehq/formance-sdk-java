...
public class V2DeleteTriggerResponse implements com.formance.formance_sdk.utils.Response {
    ...
    public V2DeleteTriggerResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public V2DeleteTriggerResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public V2DeleteTriggerResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public V2DeleteTriggerResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * General error
     */
    public V2DeleteTriggerResponse withV2Error(com.formance.formance_sdk.models.errors.V2Error v2Error) {
        Utils.checkNotNull(v2Error, "v2Error");
     ...
     * General error
     */
    public V2DeleteTriggerResponse withV2Error(Optional<? extends com.formance.formance_sdk.models.errors.V2Error> v2Error) {
        Utils.checkNotNull(v2Error, "v2Error");
        this.v2Error = v2Error;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2DeleteTriggerResponse other = (V2DeleteTriggerResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2DeleteTriggerResponse.class,
    ...
    public final static class Builder {
        ...
        public V2DeleteTriggerResponse build() {
