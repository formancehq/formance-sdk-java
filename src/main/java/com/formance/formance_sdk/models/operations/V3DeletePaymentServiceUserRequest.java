...
public class V3DeletePaymentServiceUserRequest {
    ...
    @JsonCreator
    public V3DeletePaymentServiceUserRequest(
     ...
     * The payment service user ID
     */
    public V3DeletePaymentServiceUserRequest withPaymentServiceUserID(String paymentServiceUserID) {
        Utils.checkNotNull(paymentServiceUserID, "paymentServiceUserID");
        this.paymentServiceUserID = paymentServiceUserID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3DeletePaymentServiceUserRequest other = (V3DeletePaymentServiceUserRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3DeletePaymentServiceUserRequest.class,
    ...
    public final static class Builder {
        ...
        public V3DeletePaymentServiceUserRequest build() {

            return new V3DeletePaymentServiceUserRequest(
                paymentServiceUserID);
        }
