...
public class ListConfigsAvailableConnectorsRequestBuilder {
    ...
    public ListConfigsAvailableConnectorsRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public ListConfigsAvailableConnectorsRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
