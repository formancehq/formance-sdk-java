...
public class V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest {
    ...
    @JsonCreator
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest(
    ...
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withRequestBody(Map<String, Object> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
    ...
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withRequestBody(Optional<? extends Map<String, Object>> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
     ...
     * The connector ID
     */
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withConnectorID(String connectorID) {
        Utils.checkNotNull(connectorID, "connectorID");
        this.connectorID = connectorID;
        return this;
    }
     ...
     * <p>No other parameters can be set when this parameter is set.
     */
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * <p>No other parameters can be set when this parameter is set.
     */
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withCursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * The number of items to return
     */
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of items to return
     */
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The payment service user ID
     */
    public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest withPaymentServiceUserID(String paymentServiceUserID) {
        Utils.checkNotNull(paymentServiceUserID, "paymentServiceUserID");
        this.paymentServiceUserID = paymentServiceUserID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest other = (V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest.class,
    ...
    public final static class Builder {
        ...
        public V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest build() {

            return new V3ListPaymentServiceUserLinkAttemptsFromConnectorIDRequest(
                requestBody, connectorID, cursor,
                pageSize, paymentServiceUserID);
        }
