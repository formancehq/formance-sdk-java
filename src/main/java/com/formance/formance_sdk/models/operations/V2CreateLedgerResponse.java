...
public class V2CreateLedgerResponse implements com.formance.formance_sdk.utils.Response {
     ...
     * HTTP response content type for this operation
     */
    public V2CreateLedgerResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public V2CreateLedgerResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public V2CreateLedgerResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Error
     */
    public V2CreateLedgerResponse withV2ErrorResponse(com.formance.formance_sdk.models.errors.V2ErrorResponse v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
     ...
     * Error
     */
    public V2CreateLedgerResponse withV2ErrorResponse(Optional<? extends com.formance.formance_sdk.models.errors.V2ErrorResponse> v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
        this.v2ErrorResponse = v2ErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2CreateLedgerResponse other = (V2CreateLedgerResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2CreateLedgerResponse.class,
    ...
    public final static class Builder {
        ...
        public V2CreateLedgerResponse build() {
