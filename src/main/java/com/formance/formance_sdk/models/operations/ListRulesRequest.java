...
public class ListRulesRequest {
    ...
    public ListRulesRequest withRequestBody(Map<String, Object> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
    ...
    public ListRulesRequest withRequestBody(Optional<? extends Map<String, Object>> requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
     ...
     * No other parameters can be set when this parameter is set.
     */
    public ListRulesRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * No other parameters can be set when this parameter is set.
     */
    public ListRulesRequest withCursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * The maximum number of results to return per page.
     */
    public ListRulesRequest withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The maximum number of results to return per page.
     */
    public ListRulesRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
