...
public class V2RestoreBucketResponse implements Response {
    /**
    ...
    @JsonCreator
    public V2RestoreBucketResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public V2RestoreBucketResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public V2RestoreBucketResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public V2RestoreBucketResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Bucket not found
     */
    public V2RestoreBucketResponse withV2ErrorResponse(V2ErrorResponse v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
     ...
     * Bucket not found
     */
    public V2RestoreBucketResponse withV2ErrorResponse(Optional<? extends V2ErrorResponse> v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
        this.v2ErrorResponse = v2ErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2RestoreBucketResponse other = (V2RestoreBucketResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2RestoreBucketResponse.class,
    ...
    public final static class Builder {
        ...
        public V2RestoreBucketResponse build() {
