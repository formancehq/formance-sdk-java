...
public class V3DeletePaymentServiceUserConnectorRequest {
    ...
    @JsonCreator
    public V3DeletePaymentServiceUserConnectorRequest(
            String connectorID,
     ...
     * The connector ID
     */
    public V3DeletePaymentServiceUserConnectorRequest withConnectorID(String connectorID) {
        Utils.checkNotNull(connectorID, "connectorID");
        this.connectorID = connectorID;
        return this;
    }
     ...
     * The payment service user ID
     */
    public V3DeletePaymentServiceUserConnectorRequest withPaymentServiceUserID(String paymentServiceUserID) {
        Utils.checkNotNull(paymentServiceUserID, "paymentServiceUserID");
        this.paymentServiceUserID = paymentServiceUserID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3DeletePaymentServiceUserConnectorRequest other = (V3DeletePaymentServiceUserConnectorRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3DeletePaymentServiceUserConnectorRequest.class,
    ...
    public final static class Builder {
        ...
        public V3DeletePaymentServiceUserConnectorRequest build() {

            return new V3DeletePaymentServiceUserConnectorRequest(
                connectorID, paymentServiceUserID);
        }
