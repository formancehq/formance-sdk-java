...
public class V3ListPaymentServiceUserConnectionsRequest {
     ...
     * <p>No other parameters can be set when this parameter is set.
     */
    public V3ListPaymentServiceUserConnectionsRequest withCursor(String cursor) {
        Utils.checkNotNull(cursor, "cursor");
     ...
     * <p>No other parameters can be set when this parameter is set.
     */
    public V3ListPaymentServiceUserConnectionsRequest withCursor(Optional<String> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
     ...
     * The number of items to return
     */
    public V3ListPaymentServiceUserConnectionsRequest withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
     ...
     * The number of items to return
     */
    public V3ListPaymentServiceUserConnectionsRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The payment service user ID
     */
    public V3ListPaymentServiceUserConnectionsRequest withPaymentServiceUserID(String paymentServiceUserID) {
        Utils.checkNotNull(paymentServiceUserID, "paymentServiceUserID");
        this.paymentServiceUserID = paymentServiceUserID;
        return this;
    }
