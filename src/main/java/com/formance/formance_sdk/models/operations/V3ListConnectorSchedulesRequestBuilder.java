...
public class V3ListConnectorSchedulesRequestBuilder {
    ...
    public V3ListConnectorSchedulesRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public V3ListConnectorSchedulesRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
