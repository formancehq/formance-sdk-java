...
public class V2GetVolumesWithBalancesRequestBuilder {
    ...
    public V2GetVolumesWithBalancesRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public V2GetVolumesWithBalancesRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
