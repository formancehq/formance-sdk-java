...
public class V3UpdateBankAccountMetadataRequestBuilder {
    ...
    public V3UpdateBankAccountMetadataRequestBuilder serverURL(String serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = Optional.of(serverURL);
        return this;
    }

    public V3UpdateBankAccountMetadataRequestBuilder serverURL(Optional<String> serverURL) {
        Utils.checkNotNull(serverURL, "serverURL");
        this.serverURL = serverURL;
        return this;
    }

    public V3UpdateBankAccountMetadataResponse call() {
