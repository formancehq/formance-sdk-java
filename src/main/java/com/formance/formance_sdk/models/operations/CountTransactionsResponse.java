...
public class CountTransactionsResponse implements Response {
    ...
    public CountTransactionsResponse withHeaders(Map<String, List<String>> headers) {
     ...
     * HTTP response status code for this operation
     */
    public CountTransactionsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CountTransactionsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
