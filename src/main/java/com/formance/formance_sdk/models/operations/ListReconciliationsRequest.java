...
public class ListReconciliationsRequest {
    ...
    public ListReconciliationsRequest withQuery(Map<String, Object> query) {
        Utils.checkNotNull(query, "query");
    ...
    public ListReconciliationsRequest withQuery(Optional<? extends Map<String, Object>> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
