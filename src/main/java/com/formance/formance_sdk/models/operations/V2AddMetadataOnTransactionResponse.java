...
public class V2AddMetadataOnTransactionResponse implements com.formance.formance_sdk.utils.Response {
    ...
    public V2AddMetadataOnTransactionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response status code for this operation
     */
    public V2AddMetadataOnTransactionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public V2AddMetadataOnTransactionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Error
     */
    public V2AddMetadataOnTransactionResponse withV2ErrorResponse(com.formance.formance_sdk.models.errors.V2ErrorResponse v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
     ...
     * Error
     */
    public V2AddMetadataOnTransactionResponse withV2ErrorResponse(Optional<? extends com.formance.formance_sdk.models.errors.V2ErrorResponse> v2ErrorResponse) {
        Utils.checkNotNull(v2ErrorResponse, "v2ErrorResponse");
        this.v2ErrorResponse = v2ErrorResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2AddMetadataOnTransactionResponse other = (V2AddMetadataOnTransactionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2AddMetadataOnTransactionResponse.class,
    ...
    public final static class Builder {
        ...
        public V2AddMetadataOnTransactionResponse build() {
