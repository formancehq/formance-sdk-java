...
public class V2ListExportersCursor2 {
    ...
    public V2ListExportersCursor2 withData(List<V2Exporter> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public V2ListExportersCursor2 withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public V2ListExportersCursor2 withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public V2ListExportersCursor2 withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public V2ListExportersCursor2 withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V2ListExportersCursor2 withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public V2ListExportersCursor2 withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2ListExportersCursor2 other = (V2ListExportersCursor2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2ListExportersCursor2.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public V2ListExportersCursor2 build() {

            return new V2ListExportersCursor2(
                data, hasMore, next,
                pageSize, previous);
        }
