...
public class AssetHolder2 {
    ...
    public AssetHolder2 withAssets(Map<String, BigInteger> assets) {
        Utils.checkNotNull(assets, "assets");
        this.assets = assets;
        return this;
    }

    public AssetHolder2 withExpiresAt(OffsetDateTime expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = JsonNullable.of(expiresAt);
        return this;
    }

    public AssetHolder2 withExpiresAt(JsonNullable<OffsetDateTime> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }

    public AssetHolder2 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public AssetHolder2 withPriority(BigInteger priority) {
        Utils.checkNotNull(priority, "priority");
        this.priority = Optional.ofNullable(priority);
        return this;
    }

    public AssetHolder2 withPriority(long priority) {
        this.priority = Optional.of(BigInteger.valueOf(priority));
        return this;
    }


    public AssetHolder2 withPriority(Optional<? extends BigInteger> priority) {
        Utils.checkNotNull(priority, "priority");
        this.priority = priority;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssetHolder2 other = (AssetHolder2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AssetHolder2.class,
                "assets", assets,
                "expiresAt", expiresAt,
                "name", name,
                "priority", priority);
    ...
    public final static class Builder {
        ...
        public AssetHolder2 build() {

            return new AssetHolder2(
                assets, expiresAt, name,
                priority);
        }
