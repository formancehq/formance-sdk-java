...
public class ClientOptions2 {
    ...
    public ClientOptions2(
            String name) {
        this(JsonNullable.undefined(), Optional.empty(), name,
    ...
    public ClientOptions2 withMetadata(Map<String, String> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = JsonNullable.of(metadata);
        return this;
    }

    public ClientOptions2 withMetadata(JsonNullable<? extends Map<String, String>> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public ClientOptions2 withDescription(String description) {
        Utils.checkNotNull(description, "description");
    ...
    public ClientOptions2 withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public ClientOptions2 withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public ClientOptions2 withPostLogoutRedirectUris(List<String> postLogoutRedirectUris) {
        Utils.checkNotNull(postLogoutRedirectUris, "postLogoutRedirectUris");
    ...
    public ClientOptions2 withPostLogoutRedirectUris(Optional<? extends List<String>> postLogoutRedirectUris) {
        Utils.checkNotNull(postLogoutRedirectUris, "postLogoutRedirectUris");
        this.postLogoutRedirectUris = postLogoutRedirectUris;
        return this;
    }

    public ClientOptions2 withPublic(boolean public_) {
        Utils.checkNotNull(public_, "public_");
    ...
    public ClientOptions2 withPublic(Optional<Boolean> public_) {
        Utils.checkNotNull(public_, "public_");
        this.public_ = public_;
        return this;
    }

    public ClientOptions2 withRedirectUris(List<String> redirectUris) {
        Utils.checkNotNull(redirectUris, "redirectUris");
    ...
    public ClientOptions2 withRedirectUris(Optional<? extends List<String>> redirectUris) {
        Utils.checkNotNull(redirectUris, "redirectUris");
        this.redirectUris = redirectUris;
        return this;
    }

    public ClientOptions2 withScopes(List<String> scopes) {
        Utils.checkNotNull(scopes, "scopes");
    ...
    public ClientOptions2 withScopes(Optional<? extends List<String>> scopes) {
        Utils.checkNotNull(scopes, "scopes");
        this.scopes = scopes;
        return this;
    }

    public ClientOptions2 withTrusted(boolean trusted) {
        Utils.checkNotNull(trusted, "trusted");
    ...
    public ClientOptions2 withTrusted(Optional<Boolean> trusted) {
        Utils.checkNotNull(trusted, "trusted");
        this.trusted = trusted;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientOptions2 other = (ClientOptions2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientOptions2.class,
                "metadata", metadata,
    ...
    public final static class Builder {
        ...
        public ClientOptions2 build() {

            return new ClientOptions2(
                metadata, description, name,
                postLogoutRedirectUris, public_, redirectUris,
                scopes, trusted);
        }
