...
public class V2StripeTransferRequest {
    ...
    private Optional<? extends V2StripeTransferRequestMetadata> metadata;
    ...
    @JsonCreator
    public V2StripeTransferRequest(
            ...
            @JsonProperty("metadata") Optional<? extends V2StripeTransferRequestMetadata> metadata,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<V2StripeTransferRequestMetadata> metadata() {
        return (Optional<V2StripeTransferRequestMetadata>) metadata;
    }
    ...
    public V2StripeTransferRequest withAmount(BigInteger amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = Optional.ofNullable(amount);
        return this;
    }

    public V2StripeTransferRequest withAmount(long amount) {
        this.amount = Optional.of(BigInteger.valueOf(amount));
        return this;
    }


    public V2StripeTransferRequest withAmount(Optional<? extends BigInteger> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }

    public V2StripeTransferRequest withAsset(String asset) {
        Utils.checkNotNull(asset, "asset");
    ...
    public V2StripeTransferRequest withAsset(Optional<String> asset) {
        Utils.checkNotNull(asset, "asset");
        this.asset = asset;
        return this;
    }

    public V2StripeTransferRequest withConnectorID(String connectorID) {
        Utils.checkNotNull(connectorID, "connectorID");
    ...
    public V2StripeTransferRequest withConnectorID(Optional<String> connectorID) {
        Utils.checkNotNull(connectorID, "connectorID");
        this.connectorID = connectorID;
        return this;
    }

    public V2StripeTransferRequest withDestination(String destination) {
        Utils.checkNotNull(destination, "destination");
    ...
    public V2StripeTransferRequest withDestination(Optional<String> destination) {
        Utils.checkNotNull(destination, "destination");
        this.destination = destination;
        return this;
    }
     ...
     * It can be useful for storing additional information about the transfer in a structured format.
     */
    public V2StripeTransferRequest withMetadata(V2StripeTransferRequestMetadata metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * It can be useful for storing additional information about the transfer in a structured format.
     */
    public V2StripeTransferRequest withMetadata(Optional<? extends V2StripeTransferRequestMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public V2StripeTransferRequest withWaitingValidation(boolean waitingValidation) {
        Utils.checkNotNull(waitingValidation, "waitingValidation");
    ...
    public V2StripeTransferRequest withWaitingValidation(Optional<Boolean> waitingValidation) {
        Utils.checkNotNull(waitingValidation, "waitingValidation");
        this.waitingValidation = waitingValidation;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2StripeTransferRequest other = (V2StripeTransferRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2StripeTransferRequest.class,
                "amount", amount,
                "asset", asset,
    ...
    public final static class Builder {
        ...
        private Optional<? extends V2StripeTransferRequestMetadata> metadata = Optional.empty();
         ...
         * It can be useful for storing additional information about the transfer in a structured format.
         */
        public Builder metadata(V2StripeTransferRequestMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = Optional.ofNullable(metadata);
            return this;
        }
         ...
         * It can be useful for storing additional information about the transfer in a structured format.
         */
        public Builder metadata(Optional<? extends V2StripeTransferRequestMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
