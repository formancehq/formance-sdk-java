...
public class V2Cursor {
    ...
    public V2Cursor withData(List<V2Wallet> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public V2Cursor withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
    ...
    public V2Cursor withHasMore(Optional<Boolean> hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public V2Cursor withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public V2Cursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public V2Cursor withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V2Cursor withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public V2Cursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(V2Cursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
