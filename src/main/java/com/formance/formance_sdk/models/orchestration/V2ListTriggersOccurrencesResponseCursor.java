...
public class V2ListTriggersOccurrencesResponseCursor {
    ...
    @JsonProperty("data")
    private List<V2TriggerOccurrence> data;
    ...
    public V2ListTriggersOccurrencesResponseCursor(
            @JsonProperty("data") List<V2TriggerOccurrence> data,
    ...
    @JsonIgnore
    public List<V2TriggerOccurrence> data() {
        return data;
    }
    ...
    public V2ListTriggersOccurrencesResponseCursor withData(List<V2TriggerOccurrence> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public V2ListTriggersOccurrencesResponseCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public V2ListTriggersOccurrencesResponseCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(List<V2TriggerOccurrence> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
