...
public class TriggerData2 {
    ...
    public TriggerData2 withEvent(String event) {
        Utils.checkNotNull(event, "event");
        this.event = event;
        return this;
    }

    public TriggerData2 withFilter(String filter) {
        Utils.checkNotNull(filter, "filter");
    ...
    public TriggerData2 withFilter(Optional<String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }

    public TriggerData2 withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public TriggerData2 withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public TriggerData2 withVars(Map<String, Object> vars) {
        Utils.checkNotNull(vars, "vars");
    ...
    public TriggerData2 withVars(Optional<? extends Map<String, Object>> vars) {
        Utils.checkNotNull(vars, "vars");
        this.vars = vars;
        return this;
    }

    public TriggerData2 withVersion(String version) {
        Utils.checkNotNull(version, "version");
    ...
    public TriggerData2 withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }

    public TriggerData2 withWorkflowID(String workflowID) {
        Utils.checkNotNull(workflowID, "workflowID");
        this.workflowID = workflowID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TriggerData2 other = (TriggerData2) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TriggerData2.class,
                "event", event,
                "filter", filter,
                "name", name,
                "vars", vars,
    ...
    public final static class Builder {
        ...
        public TriggerData2 build() {

            return new TriggerData2(
                event, filter, name,
                vars, version, workflowID);
        }
