...
public class Response {
    ...
    @JsonProperty("cursor")
    private Optional<? extends Cursor> cursor;
    ...
    @JsonCreator
    public Response(
            @JsonProperty("cursor") Optional<? extends Cursor> cursor,
    ...
    public Response withCursor(Cursor cursor) {
        Utils.checkNotNull(cursor, "cursor");
    ...
    public Response withCursor(Optional<? extends Cursor> cursor) {
        Utils.checkNotNull(cursor, "cursor");
        this.cursor = cursor;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends Cursor> cursor = Optional.empty();
        ...
        public Builder cursor(Optional<? extends Cursor> cursor) {
            Utils.checkNotNull(cursor, "cursor");
            this.cursor = cursor;
            return this;
        }
