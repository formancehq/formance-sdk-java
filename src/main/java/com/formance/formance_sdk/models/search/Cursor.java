 ...
 */
package com.formance.formance_sdk.models.search;
...
public class Cursor {
    ...
    public Cursor withData(List<Map<String, Object>> data) {
        Utils.checkNotNull(data, "data");
    ...
    public Cursor withData(Optional<? extends List<Map<String, Object>>> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }

    public Cursor withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
    ...
    public Cursor withHasMore(Optional<Boolean> hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public Cursor withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public Cursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public Cursor withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
    ...
    public Cursor withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public Cursor withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public Cursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }

    public Cursor withTotal(Total total) {
        Utils.checkNotNull(total, "total");
    ...
    public Cursor withTotal(Optional<? extends Total> total) {
        Utils.checkNotNull(total, "total");
        this.total = total;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Cursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
