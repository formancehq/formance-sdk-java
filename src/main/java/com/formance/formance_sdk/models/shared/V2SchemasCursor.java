...
public class V2SchemasCursor {
    ...
    public V2SchemasCursor withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public V2SchemasCursor withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public V2SchemasCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public V2SchemasCursor withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V2SchemasCursor withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public V2SchemasCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2SchemasCursor other = (V2SchemasCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2SchemasCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public V2SchemasCursor build() {

            return new V2SchemasCursor(
                data, hasMore, next,
                pageSize, previous);
        }
