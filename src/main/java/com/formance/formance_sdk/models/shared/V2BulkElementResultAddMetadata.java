...
public class V2BulkElementResultAddMetadata implements V2BulkElementResult {
    ...
    @JsonCreator
    public V2BulkElementResultAddMetadata(
    ...
    public V2BulkElementResultAddMetadata withResponseType(String responseType) {
        Utils.checkNotNull(responseType, "responseType");
        this.responseType = responseType;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(V2BulkElementResultAddMetadata.class,
                "logID", logID,
