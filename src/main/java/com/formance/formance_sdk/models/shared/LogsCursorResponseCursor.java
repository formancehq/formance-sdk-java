...
public class LogsCursorResponseCursor {
    ...
    @JsonProperty("data")
    private java.util.List<Log> data;
    ...
    public LogsCursorResponseCursor(
            @JsonProperty("data") java.util.List<Log> data,
    ...
    @JsonIgnore
    public java.util.List<Log> data() {
        return data;
    }
    ...
    public LogsCursorResponseCursor withData(java.util.List<Log> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public LogsCursorResponseCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public LogsCursorResponseCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LogsCursorResponseCursor other = (LogsCursorResponseCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LogsCursorResponseCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<Log> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public LogsCursorResponseCursor build() {
            return new LogsCursorResponseCursor(
                data,
                hasMore,
                next,
                pageSize,
