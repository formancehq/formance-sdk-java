...
public class LogsCursorResponseCursor {
    ...
    public LogsCursorResponseCursor withData(List<Log> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public LogsCursorResponseCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public LogsCursorResponseCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
