...
public class CreateBalanceResponse {
    ...
    @JsonProperty("data")
    private CreateBalanceRequest data;

    @JsonCreator
    public CreateBalanceResponse(
            @JsonProperty("data") CreateBalanceRequest data) {
    ...
    public CreateBalanceResponse withData(CreateBalanceRequest data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(CreateBalanceRequest data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
