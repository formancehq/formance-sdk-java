...
public class OrchestrationV2PostTransactionScript {
    ...
    @JsonCreator
    public OrchestrationV2PostTransactionScript(
    ...
    public OrchestrationV2PostTransactionScript withVars(Map<String, Object> vars) {
        Utils.checkNotNull(vars, "vars");
    ...
    public String toString() {
        return Utils.toString(OrchestrationV2PostTransactionScript.class,
                "plain", plain,
                "vars", vars);
    }
