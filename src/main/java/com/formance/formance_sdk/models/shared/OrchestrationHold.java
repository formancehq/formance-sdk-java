...
public class OrchestrationHold {
    ...
    public OrchestrationHold withDestination(Subject destination) {
        Utils.checkNotNull(destination, "destination");
     ...
     * The unique ID of the hold.
     */
    public OrchestrationHold withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Metadata associated with the hold.
     */
    public OrchestrationHold withMetadata(Map<String, String> metadata) {
     ...
     * The ID of the wallet the hold is associated with.
     */
    public OrchestrationHold withWalletID(String walletID) {
        Utils.checkNotNull(walletID, "walletID");
        this.walletID = walletID;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(OrchestrationHold.class,
