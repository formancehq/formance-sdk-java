...
public class V2LogsCursorResponseCursor {
    ...
    @JsonProperty("data")
    private java.util.List<V2Log> data;
    ...
    public V2LogsCursorResponseCursor(
            @JsonProperty("data") java.util.List<V2Log> data,
    ...
    @JsonIgnore
    public java.util.List<V2Log> data() {
        return data;
    }
    ...
    public V2LogsCursorResponseCursor withData(java.util.List<V2Log> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public V2LogsCursorResponseCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public V2LogsCursorResponseCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<V2Log> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
