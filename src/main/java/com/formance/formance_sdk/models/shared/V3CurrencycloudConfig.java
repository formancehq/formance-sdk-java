...
public class V3CurrencycloudConfig implements V3InstallConnectorRequest {
    ...
    public V3CurrencycloudConfig(
            ...
            String loginID,
            String name) {
        this(apiKey, endpoint, loginID, name, Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    public V3CurrencycloudConfig withApiKey(String apiKey) {
        Utils.checkNotNull(apiKey, "apiKey");
        this.apiKey = apiKey;
        return this;
    }

    public V3CurrencycloudConfig withEndpoint(String endpoint) {
        Utils.checkNotNull(endpoint, "endpoint");
        this.endpoint = endpoint;
        return this;
    }

    public V3CurrencycloudConfig withLoginID(String loginID) {
        Utils.checkNotNull(loginID, "loginID");
        this.loginID = loginID;
        return this;
    }

    public V3CurrencycloudConfig withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public V3CurrencycloudConfig withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = Optional.ofNullable(pageSize);
        return this;
    }

    public V3CurrencycloudConfig withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V3CurrencycloudConfig withPollingPeriod(String pollingPeriod) {
        Utils.checkNotNull(pollingPeriod, "pollingPeriod");
        this.pollingPeriod = Optional.ofNullable(pollingPeriod);
        return this;
    }

    public V3CurrencycloudConfig withPollingPeriod(Optional<String> pollingPeriod) {
        Utils.checkNotNull(pollingPeriod, "pollingPeriod");
        this.pollingPeriod = pollingPeriod;
        return this;
    }

    public V3CurrencycloudConfig withProvider(String provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = Optional.ofNullable(provider);
        return this;
    }

    public V3CurrencycloudConfig withProvider(Optional<String> provider) {
        Utils.checkNotNull(provider, "provider");
        this.provider = provider;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3CurrencycloudConfig other = (V3CurrencycloudConfig) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3CurrencycloudConfig.class,
                "apiKey", apiKey,
                "endpoint", endpoint,
                "loginID", loginID,
                "name", name,
    ...
    public final static class Builder {
        ...
        public V3CurrencycloudConfig build() {
            if (pageSize == null) {
            ...
            return new V3CurrencycloudConfig(
                apiKey,
                endpoint,
                loginID,
                name,
