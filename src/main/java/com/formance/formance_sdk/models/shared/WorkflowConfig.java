...
public class WorkflowConfig {
    ...
    public WorkflowConfig withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public WorkflowConfig withStages(java.util.List<java.util.Map<String, java.lang.Object>> stages) {
        Utils.checkNotNull(stages, "stages");
        this.stages = stages;
        return this;
    }
