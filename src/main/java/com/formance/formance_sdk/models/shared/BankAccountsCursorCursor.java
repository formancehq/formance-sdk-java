...
public class BankAccountsCursorCursor {
    ...
    @JsonProperty("data")
    private java.util.List<BankAccount> data;
    ...
    public BankAccountsCursorCursor(
            @JsonProperty("data") java.util.List<BankAccount> data,
    ...
    public BankAccountsCursorCursor(
            java.util.List<BankAccount> data,
            boolean hasMore,
            long pageSize) {
    ...
    @JsonIgnore
    public java.util.List<BankAccount> data() {
        return data;
    }
    ...
    public BankAccountsCursorCursor withData(java.util.List<BankAccount> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public BankAccountsCursorCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public BankAccountsCursorCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<BankAccount> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
