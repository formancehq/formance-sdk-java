...
public class V2AccountsCursorResponseCursor {
    ...
    @JsonProperty("data")
    private java.util.List<V2Account> data;
    ...
    @JsonCreator
    public V2AccountsCursorResponseCursor(
            @JsonProperty("data") java.util.List<V2Account> data,
    ...
    @JsonIgnore
    public java.util.List<V2Account> data() {
        return data;
    }
    ...
    public V2AccountsCursorResponseCursor withData(java.util.List<V2Account> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public V2AccountsCursorResponseCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public V2AccountsCursorResponseCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2AccountsCursorResponseCursor other = (V2AccountsCursorResponseCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2AccountsCursorResponseCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<V2Account> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public V2AccountsCursorResponseCursor build() {
            return new V2AccountsCursorResponseCursor(
                data,
                hasMore,
                next,
                pageSize,
