...
public class V2WalletSubject implements V2Subject {
    ...
    public V2WalletSubject withBalance(Optional<? extends String> balance) {
        Utils.checkNotNull(balance, "balance");
        this.balance = balance;
        return this;
    }

    public V2WalletSubject withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }

    public V2WalletSubject withType(String type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(V2WalletSubject.class,
                "balance", balance,
