...
public class ListTriggersOccurrencesResponse {
    ...
    @JsonProperty("data")
    private java.util.List<TriggerOccurrence> data;

    @JsonCreator
    public ListTriggersOccurrencesResponse(
            @JsonProperty("data") java.util.List<TriggerOccurrence> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
    }

    @JsonIgnore
    public java.util.List<TriggerOccurrence> data() {
        return data;
    }
    ...
    public ListTriggersOccurrencesResponse withData(java.util.List<TriggerOccurrence> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<TriggerOccurrence> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
