...
public class V2ListTriggersResponseCursor {
    ...
    @JsonProperty("data")
    private java.util.List<V2Trigger> data;
    ...
    public V2ListTriggersResponseCursor(
            @JsonProperty("data") java.util.List<V2Trigger> data,
    ...
    @JsonIgnore
    public java.util.List<V2Trigger> data() {
        return data;
    }
    ...
    public V2ListTriggersResponseCursor withData(java.util.List<V2Trigger> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public V2ListTriggersResponseCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public V2ListTriggersResponseCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2ListTriggersResponseCursor other = (V2ListTriggersResponseCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2ListTriggersResponseCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<V2Trigger> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public V2ListTriggersResponseCursor build() {
            return new V2ListTriggersResponseCursor(
                data,
                hasMore,
                next,
                pageSize,
