...
public class V2BulkElementResultRevertTransaction implements V2BulkElementResult {
    ...
    @JsonCreator
    public V2BulkElementResultRevertTransaction(
    ...
    public V2BulkElementResultRevertTransaction withLogID(long logID) {
        Utils.checkNotNull(logID, "logID");
        this.logID = logID;
        return this;
    }

    public V2BulkElementResultRevertTransaction withResponseType(String responseType) {
        Utils.checkNotNull(responseType, "responseType");
        this.responseType = responseType;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(V2BulkElementResultRevertTransaction.class,
                "data", data,
                "logID", logID,
