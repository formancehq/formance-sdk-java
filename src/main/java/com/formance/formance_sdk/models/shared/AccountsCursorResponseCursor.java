...
public class AccountsCursorResponseCursor {
    ...
    @JsonProperty("data")
    private java.util.List<Account> data;
    ...
    public AccountsCursorResponseCursor(
            @JsonProperty("data") java.util.List<Account> data,
    ...
    @JsonIgnore
    public java.util.List<Account> data() {
        return data;
    }
    ...
    public AccountsCursorResponseCursor withData(java.util.List<Account> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public AccountsCursorResponseCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public AccountsCursorResponseCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountsCursorResponseCursor other = (AccountsCursorResponseCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountsCursorResponseCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<Account> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
        ...
        public AccountsCursorResponseCursor build() {
            return new AccountsCursorResponseCursor(
                data,
                hasMore,
                next,
                pageSize,
