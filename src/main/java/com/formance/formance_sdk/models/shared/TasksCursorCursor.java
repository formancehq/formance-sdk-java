...
public class TasksCursorCursor {
    ...
    @JsonProperty("data")
    private java.util.List<TasksCursorData> data;
    ...
    public TasksCursorCursor(
            @JsonProperty("data") java.util.List<TasksCursorData> data,
    ...
    public TasksCursorCursor(
            java.util.List<TasksCursorData> data,
            boolean hasMore,
            long pageSize) {
    ...
    @JsonIgnore
    public java.util.List<TasksCursorData> data() {
        return data;
    }
    ...
    public TasksCursorCursor withData(java.util.List<TasksCursorData> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public TasksCursorCursor withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public TasksCursorCursor withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(TasksCursorCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public Builder data(java.util.List<TasksCursorData> data) {
            Utils.checkNotNull(data, "data");
            this.data = data;
            return this;
        }
