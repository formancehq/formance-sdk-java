...
public class PoliciesCursorResponseCursor {
    ...
    public PoliciesCursorResponseCursor(
            @JsonProperty("data") List<Policy> data,
    ...
    public PoliciesCursorResponseCursor withData(List<Policy> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public PoliciesCursorResponseCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public PoliciesCursorResponseCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
