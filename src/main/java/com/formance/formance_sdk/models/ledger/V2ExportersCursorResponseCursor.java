...
public class V2ExportersCursorResponseCursor {
    ...
    public V2ExportersCursorResponseCursor withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public V2ExportersCursorResponseCursor withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public V2ExportersCursorResponseCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public V2ExportersCursorResponseCursor withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V2ExportersCursorResponseCursor withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public V2ExportersCursorResponseCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2ExportersCursorResponseCursor other = (V2ExportersCursorResponseCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2ExportersCursorResponseCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public V2ExportersCursorResponseCursor build() {

            return new V2ExportersCursorResponseCursor(
                data, hasMore, next,
                pageSize, previous);
        }
