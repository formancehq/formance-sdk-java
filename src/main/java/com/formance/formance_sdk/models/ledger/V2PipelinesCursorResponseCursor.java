...
public class V2PipelinesCursorResponseCursor {
    ...
    public V2PipelinesCursorResponseCursor withHasMore(boolean hasMore) {
        Utils.checkNotNull(hasMore, "hasMore");
        this.hasMore = hasMore;
        return this;
    }

    public V2PipelinesCursorResponseCursor withNext(String next) {
        Utils.checkNotNull(next, "next");
    ...
    public V2PipelinesCursorResponseCursor withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }

    public V2PipelinesCursorResponseCursor withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public V2PipelinesCursorResponseCursor withPrevious(String previous) {
        Utils.checkNotNull(previous, "previous");
    ...
    public V2PipelinesCursorResponseCursor withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2PipelinesCursorResponseCursor other = (V2PipelinesCursorResponseCursor) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V2PipelinesCursorResponseCursor.class,
                "data", data,
                "hasMore", hasMore,
                "next", next,
                "pageSize", pageSize,
    ...
    public final static class Builder {
        ...
        public V2PipelinesCursorResponseCursor build() {

            return new V2PipelinesCursorResponseCursor(
                data, hasMore, next,
                pageSize, previous);
        }
