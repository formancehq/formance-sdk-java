...
public class ErrorsV2ErrorResponse extends SDKBaseError {
    ...
    /**
    * Parse a response into an instance of ErrorsV2ErrorResponse. If deserialization of the response body fails,
    * the resulting ErrorsV2ErrorResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static ErrorsV2ErrorResponse from(HttpResponse<InputStream> response) {
        try {
            byte[] bytes = Utils.extractByteArrayFromBody(response);
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new ErrorsV2ErrorResponse(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new ErrorsV2ErrorResponse(response.statusCode(), null, response, null, e);
        }
    }
